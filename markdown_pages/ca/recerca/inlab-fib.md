[Vés al contingut](ca/recerca/inlab-fib.md)
...
[Inici](ca.md) » [Recerca](ca/recerca.md) » inLab FIB
...
L'[inLab FIB](index.md) és un laboratori d’innovació i recerca de la Facultat
d’Informàtica de Barcelona de la UPC especialitzat en el desenvolupament de
projectes R+D+i multidisciplinars en l'àmbit de les Tecnologies de la
Informació i de les Comunicacions.

[![](/sites/fib/files/images/fib/logo_inlabfib_pet.png)](index.md)

La finalitat d’aquesta tasca és doble. D’una banda, innovar i transferir
coneixement a la societat per tal de facilitar que les empreses i les
institucions públiques puguin proporcionar millors serveis a la societat. De
l’altra, el desenvolupament del talent humà dels estudiants de la FIB en el
marc d’un programa de formació integral, el programa Talent, que complementa
la seva formació estrictament acadèmica.

L’inLab FIB té el reconeixement de centre TECNIO, acreditació que atorga
[ACCIÓ](ca/inici.md), l’Agència per la Competitivitat de l’Empresa de la
Generalitat de Catalunya, des del 2019.

##  **Àrees R+D+i**

Les [àrees d'expertesa de l'inLab FIB](ca/arees-expertesa.md), són la Ciència
de les Dades i el Big Data; la Mobilitat Intel·ligent; l’Enginyeria del
Coneixement i dels Serveis; la Ciberseguretat; la Simulació i l’Optimització;
i els Entorns TIC de Suport a l’Aprenentatge.

![](/sites/fib/files/documents/parkfinder_2.jpg)

## **Programa Talent**

Pels estudiants de la FIB, l'inLab és un entorn professional de
desenvolupament de [projectes innovadors](ca/projectes.md) que incorpora la
formació com objectiu, dins del Programa Talent. Els estudiants s’integren a
equips formats per personal tècnic (PAS) i professors amb àmplia experiència.

L'objectiu d'aquesta formació és aconseguir, mitjançant les pràctiques
curriculars o extracurriculars dels estudiants, una formació integral de
l'alumne que complementi la que obté amb el seguiment ordinari dels estudis.

La [participació de les empreses](ca/programa-talent.md) en aquest programa
s'articula a través de l'esponsorització i col·laboració en projectes
formatius específics orientats a la formació integral dels estudiants.
...
[Configuració de privadesa](ca/recerca/inlab-fib.md)
