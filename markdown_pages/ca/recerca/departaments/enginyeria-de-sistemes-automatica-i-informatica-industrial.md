[Vés al contingut](ca/recerca/departaments/enginyeria-de-sistemes-automatica-
i-informatica-industrial.md)
  ...
  * [Català](ca/recerca/departaments/enginyeria-de-sistemes-automatica-i-informatica-industrial.md "Enginyeria de Sistemes, Automàtica i Informàtica Industrial")
  * [English](en/research/departments/automatic-control.md "Automatic Control")
  * [Español](es/investigacion/departamentos/ingenieria-de-sistemas-automatica-e-informatica-industrial.md "Ingeniería de Sistemas, Automática e Informática Industrial")
...
[ __](ca/recerca/departaments/enginyeria-de-sistemes-automatica-i-informatica-
industrial.md)
...
[Inici](ca.md) » [Recerca](ca/recerca.md) »
[Departaments](ca/recerca/departaments.md) » Enginyeria de Sistemes,
...
El Departament d'Enginyeria de Sistemes, Automàtica i Informàtica Industrial
(ESAII) de la Universitat Politècnica de Catalunya (UPC) impulsa la recerca i
la docència tant els aspectes bàsics com els d'aplicació dels àmbits següents:

  * **Robòtica**  
Dins del camp de la robòtica es treballa en la incorporació de sensors i
sistemes de percepció per al desenvolupament d'estratègies de control i
aplicacions més eficients, més intel·ligents o més fiables; en els camps de la
robòtica industrial; la robòtica mèdica i la robòtica submarina.

  * **Senyals i sistemes biomèdics**  
El treball en aquesta línia de recerca es realitza en els següents temes:
estudi dels senyals biomèdics per a la identificació de diverses patologies,
disseny i desenvolupament de sistemes automàtics d'ajuda al diagnòstic clínic
i en la utilització de tècniques de modelització i simulació per a la
caracterització del comportament biològic.

  * **Sistemes avançats de control**  
Els objectius principals d'aquesta línia de recerca abasten des del
desenvolupament de noves tècniques per a la supervisió i diagnòstic de falles
en temps real, fins el disseny de controladors avançats, sistemes de control
distribuït i sistemes de control intel·ligent.

  * **Visió per ordinador**  
Dins de la línia de visió per ordinador es treballa en l'estudi i el
desenvolupament d'algoritmes especialitzats en el tractament d'imatges en
temps real per aplicacions industrials específiques i el desenvolupament de
sistemes de percepció visual.

El departament realitza la seva investigació i transferència de tecnologia
mitjançant els seus [grups de recerca](ca/recerca/grups-de-recerca.md).

## Producció científica

Dona una ullada a la pàgina web de la producció científica de la recerca de la
UPC: [futur.upc.edu](707.md)
...
[ Consulta els càrrecs i membres del departament al directori UPC.
](directori/dadesUE.jsp.md)
...
[Configuració de privadesa](ca/recerca/departaments/enginyeria-de-sistemes-
automatica-i-informatica-industrial.md)
