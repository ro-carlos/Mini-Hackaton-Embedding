[Vés al contingut](ca/recerca/departaments/ciencies-de-la-computacio.md)
  ...
  * [Català](ca/recerca/departaments/ciencies-de-la-computacio.md "Ciències de la Computació")
  * [English](en/research/departments/computer-science.md "Computer Science")
  * [Español](es/investigacion/departamentos/ciencias-de-la-computacion.md "Ciencias de la Computación")
...
[ __](ca/recerca/departaments/ciencies-de-la-computacio.md)
...
[Departaments](ca/recerca/departaments.md) » Ciències de la Computació
...
El Departament de Ciències de la Computació (CS) de la Universitat Politècnica
de Catalunya (UPC) imparteix docència i fomenta la recerca en nombroses
temàtiques relacionades amb la informàtica bàsica i les seves aplicacions:
Algorísmia, Programació, Gràfics per Computador, Intel.ligència Artificial,
Teoria de la Computació, Aprenentatge Automàtic, Processament del Llenguatge
Natural....El nucli de les seves activitats docents es concentra en els
programes de grau i màster de la Facultat d'Informàtica de Barcelona, però
ltambé imparteix classes a altres escoles de la UPC:

La recerca desenvolupada al departament s'organitza en diversos [grups de
recerca](research.md), que cobreixen diferents disciplines del camp de les
ciències de la computació. Té una presència activa en les principals
conferències de l'àmbit i una intensa participació en projectes públics i
industrials, així com en la creació d'spin-offs.

## Producció científica

Dona una ullada a la pàgina web de la producció científica de la recerca de la
UPC: [futur.upc.edu](723.md)
...
[Configuració de privadesa](ca/recerca/departaments/ciencies-de-la-
computacio.md)
