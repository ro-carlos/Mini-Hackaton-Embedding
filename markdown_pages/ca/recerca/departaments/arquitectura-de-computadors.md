[Vés al contingut](ca/recerca/departaments/arquitectura-de-computadors.md)
  ...
  * [Català](ca/recerca/departaments/arquitectura-de-computadors.md "Arquitectura de Computadors")
  * [English](en/research/departments/computer-architecture.md "Computer Architecture")
  * [Español](es/investigacion/departamentos/arquitectura-de-computadores.md "Arquitectura de Computadores")
...
[ __](ca/recerca/departaments/arquitectura-de-computadors.md)
...
[Departaments](ca/recerca/departaments.md) » Arquitectura de Computadors
...
El Departament d'Arquitectura de Computadors (DAC) de la Universitat
Politècnica de Catalunya (UPC) imparteix docència i fomenta la recerca en
temàtiques relacionades amb els àmbits d'Arquitectura de Computadors, Xarxes
de Computadors i Sistemes Operatius.  
La recerca desenvolupada al DAC s'organitza en diversos [grups de
recerca](ca/recerca/grups-de-recerca.md). La seva producció científica es
publica a les conferències i revistes més importants de la seva àrea de
coneixement.

## Producció científica

Dona una ullada a la pàgina web de la producció científica de la recerca de la
UPC: [futur.upc.edu](701.md)
...
[Configuració de privadesa](ca/recerca/departaments/arquitectura-de-
computadors.md)
