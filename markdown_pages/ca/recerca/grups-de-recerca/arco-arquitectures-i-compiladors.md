[Vés al contingut](ca/recerca/grups-de-recerca/arco-arquitectures-i-
compiladors.md)
...
[ __](ca/recerca/grups-de-recerca/arco-arquitectures-i-compiladors.md)
...
Recerca](ca/recerca/grups-de-recerca.md) » ARCO - Arquitectures i Compiladors
...
El grup de recerca Architectures and Compilers (ARCO) està format per membres
del departament d'Arquitectura de Computadors de la UPC, membres del
departament de Ciències de la Computació de la URV i col·laboradors externs de
la indústria. La recerca del grup està centrada en microarquitectures i
compiladors per futurs processadors, tenint en consideració la tecnologia
sugjacent. L'objectiu principal és l'augment del rendiment, la millora de la
fiabilitat i la reducció de la disipació d'energia dels futurs processadors.
...
[Configuració de privadesa](ca/recerca/grups-de-recerca/arco-arquitectures-i-
compiladors.md)
