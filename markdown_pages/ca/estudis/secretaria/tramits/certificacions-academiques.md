[Vés al contingut](ca/estudis/secretaria/tramits/certificacions-
academiques.md)
...
[ __](ca/estudis/secretaria/tramits/certificacions-academiques.md)
...
[Secretaria](ca/estudis/secretaria.md) »
[Tràmits](ca/estudis/secretaria/tramits.md) » Certificacions acadèmiques

Es sol·licita a l'[e-Secretaria](estudiants.md) i s'obtindrà màxim en 4 dies
hàbils.

_Si tens accés a l'e-Secretaria,_

  1. **Inicia sessió** : Utilitza les teves credencials d'accés a les Intranets de la UPC.
  2. **Cerca el****tràmit:** Al menú esquerre  _Certificats_
  3. **Tria el certificat** : Indica el tipus de certificat que necessites (per exemple, Certificat acadèmic personal).
  4. **Completa les dades** : Especifica l'idioma i el mètode de pagament.
  5. **Paga les taxes** : Realitza el pagament en línia a través de la e-Secretaria. 
    1. En el menú _Matrícula_ , escollir l'opció _Impresos i pagaments_.
    2. Seleccionar el darrer imprès de "Certificació acadèmica" i prémer el logo de la targeta de crèdit o de la _Línia Oberta_ de _La Caixa_ _._
    3. Escollir una de les dues opcions del llistat i s'obrirà una pàgina on confirmar el pagament directament amb l'entitat bancària. Trobareu més informació per realitzar el pagament en línia en el document [d'instruccions per fer el pagament per l'e-Secretaria _._](sga/ca/matricula/pagament-de-la-matricula/visa-mastercard-linea-oberta.md)

_Si no tens accés a la e-Secretària_ ,

  1. **Envia un correu** : escriu a  adjuntant una fotocòpia del DNI vigent (en cas de persones amb nacionalitat espanyola) o del passaport (en cas de persones amb nacionalitat estrangera).

__**Important**

  * **Termini de lliurament**. Màxim 4 dies hàbils. 
  * **Legalització**. Per tal que els documents acadèmics originals tinguin efectes a l’estranger és necessari dur a terme la legalització.

La **legalització de documents** acadèmics originals que han de tenir efectes
a l’estranger és un procés convingut amb caràcter internacional que requereix
prèviament el reconeixement de signatures per part de les autoritats
espanyoles corresponents. En el cas concret dels certificats acadèmics
oficials d’estudis conduents a l’obtenció dels títols, expedits i signats per
càrrecs acadèmics de les unitats acadèmiques de la UPC (centres docents,
departaments i instituts universitaris de recerca) s'ha de demanar el
certificat per legalitzar.

Tràmit en línia

[e-Secretaria](estudiants.md)

  * [Quan](ca/estudis/secretaria/tramits/certificacions-academiques.md)
  * [ Dirigit a](ca/estudis/secretaria/tramits/certificacions-academiques.md)
  * [ Taxes](ca/estudis/secretaria/tramits/certificacions-academiques.md)
  * [ Contacte](ca/estudis/secretaria/tramits/certificacions-academiques.md)

Es poden sol·licitar durant tot el curs.

Persones titulades o que estiguin cursant (o hagin cursat) estudis a la FIB.

27,27 € (13,63 €, si l'estudiant pertany a família nombrosa. Aquesta
circumstància s'ha de justificar mitjançant el títol corresponent).
...
[Configuració de privadesa](ca/estudis/secretaria/tramits/certificacions-
academiques.md)
