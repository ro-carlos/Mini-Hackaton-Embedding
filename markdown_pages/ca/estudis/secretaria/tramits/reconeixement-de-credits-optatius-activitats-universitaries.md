[Vés al contingut](ca/estudis/secretaria/tramits/reconeixement-de-credits-
optatius-activitats-universitaries.md)
  ...
  * [Català](ca/estudis/secretaria/tramits/reconeixement-de-credits-optatius-activitats-universitaries.md "Reconeixement de crèdits optatius per activitats universitàries")
  * English
  * [Español](es/estudios/secretaria/tramites/reconocimiento-de-creditos-optativos-por-actividades-de-extension-universitaria.md "Reconocimiento de créditos optativos por actividades de extensión universitaria")
...
[ __](ca/estudis/secretaria/tramits/reconeixement-de-credits-optatius-
activitats-universitaries.md)
...
# Reconeixement de crèdits optatius per activitats universitàries

## Esteu aquí

[Inici](ca.md) » [Estudis](ca/estudis.md) »
[Secretaria](ca/estudis/secretaria.md) »
[Tràmits](ca/estudis/secretaria/tramits.md) » Reconeixement de crèdits
optatius per activitats universitàries

La normativa acadèmica de graus de la UPC contempla la **possibilitat de
reconèixer fins a 6 ECTS optatius** per activitats d'extensió universitària,
[4.1.6. Reconeixement de crèdits per activitats d’extensió
universitària](sga/ca/normatives/NormativesAcademiques.md).

D’aquestes activitats,**** per a l'**estudiantat de grau** , hi ha ofertades
per a tota la UPC [Veure l'annex
1](sga/ca/normatives/ReconeixementCredits.md); i també n'hi ha d'
[específiques acordades per la
FIB](sites/fib/files/documents/acord_cp2023.08.03-reconeixment_academic_activitats_especifiques_fib.pdf.md).

A la seva [e-Secretaria](estudiants.md), l'estudiantat pot consultar el
llistat de totes les activitats que han realitzat simultàniament als estudis
de grau.

### Com fer el reconeixement d'aquests ECTS optatius?

  1. Obtenir un certificat acreditatiu de l'activitat. En el cas que l'organització de l'activitat faciliti la informació directament a la secretaria de la FIB, no cal aportar el certificat.
  2. Realitzar la petició de reconeixement via [Seu electrònica > Reconeixement de crèdits optatius per activitats universitàries](ca/Tramits/Sol-licitud_incorporacio_credits_extensio_universitaria.md) durant el període corresponent **(novembre/abril)**.
  3. Tramitació per part de la secretaria de la FIB per autoritzar els crèdits.

__**Important**. Els crèdits dels reconeixements no es matriculen.

  4. Després de la darrera matrícula, l'estudiantat podrà seleccionar a **e-Secretaria > Expedient > Reconeixement d'activitats** quines de les activitats realitzades vol que **s’incorporin** al seu expedient de grau.

__**Important**. Aquesta acció no es pot desfer un cop afegides les
activitats.

  5. Realitzar el pagament de les taxes des de la seva **e-Secretaria > Impresos i pagaments**.

###

### Reconeixement de crèdits d’idiomes

El reconeixement de crèdits d'idiomes només es pot fer mitjançant certificat
oficial d'idiomes. [Consulta els certificats oficials
d'idiomes](slt/ca/cursos-i-certificats/certifica/taulacertificats.md).

Per tramitar-ho, has de fer una sol·licitud a través de la [Seu electrònica >
Reconeixement de crèdits optatius per activitats
universitàries](ca/Tramits/Sol-
licitud_incorporacio_credits_extensio_universitaria.md),**** on podràs
adjuntar el **certificat** i**** també hauràs**d'indicar els crèdits a
reconèixer en el tràmit.**

Si el certificat oficial de **B2 o superior** , que s'ha utilitzat per assolir
la competència en una tercera llengua, s'ha**obtingut durant** els estudis de
grau, també, es pot fer servir per al reconeixement de **4 ECTS**(6 ECTS en
cas de certificats d'anglès, francès, alemany o italià dels nivells del MECRL
de les Universitats Catalanes, IOC i EOI), en aquest cas:

  1. No s'ha de tornar a enviar el certificat per la seu electrònica.

  2. S'ha de fer una**** sol·licitud a través de la **e-Secretaria > altres**, _després de la última matrícula del grau_ i en els períodes establerts, (novembre/abril), sol·licitant el nombre de crèdits optatius, que es volen reconèixer.

Es pot trobar més informació sobre el reconeixement de crèdits per idiomes al
[web del Servei de Llengües i Terminologies (SLT-UPC)](slt/ca/cursos-i-
certificats/certifica/reconeixement-credits.md).

 __Abans de sol·licitar aquest reconeixement s'ha d'haver[acreditat la
competència de la tercera llengua](ca/estudis/secretaria/tramits/acreditacio-
competencia-generica-en-3a-llengua.md). Aquestes activitats s’hauran d'haver
fet simultàniament als estudis i el reconeixement s’ha de sol·licitar un cop
feta la última matrícula del grau.

Tràmit en línia

[Sede Electrónica UPC](ca/Tramits/Sol-
licitud_incorporacio_credits_extensio_universitaria.md)

  * [Quan](ca/estudis/secretaria/tramits/reconeixement-de-credits-optatius-activitats-universitaries.md)
  * [ Dirigit a](ca/estudis/secretaria/tramits/reconeixement-de-credits-optatius-activitats-universitaries.md)
  * [ Normativa associada](ca/estudis/secretaria/tramits/reconeixement-de-credits-optatius-activitats-universitaries.md)
  * [ Taxes](ca/estudis/secretaria/tramits/reconeixement-de-credits-optatius-activitats-universitaries.md)
  * [ Contacte](ca/estudis/secretaria/tramits/reconeixement-de-credits-optatius-activitats-universitaries.md)
...
Estudiantat de grau de la FIB

[Reconeixement de crèdits](sga/ca/normatives/ReconeixementCredits.md)

[Reconeixement de crèdits d'idiomes (SLT-UPC)](slt/ca/cursos-i-
certificats/certifica/reconeixement-credits.md)

[Taula de certificats acreditatius d'idiomes](slt/ca/cursos-i-
certificats/certifica/taulacertificats.md)

El reconeixement de crèdits té un cost del 15% del preu del crèdit.

## [Àrea de Gestió Acadèmica (Secretaria)](ca/contact/area-de-gestio-
academica-secretaria.md)
...
Atenció presencial amb [cita prèvia](omirXW382RQi2jtV9.md).  
...
[Configuració de privadesa](ca/estudis/secretaria/tramits/reconeixement-de-
credits-optatius-activitats-universitaries.md)
