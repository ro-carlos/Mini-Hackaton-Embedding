...
incoming-2a-matricula.md)
  ...
  * [Català](ca/estudis/secretaria/tramits/matricula-incoming-2a-matricula.md "Matrícula Incoming \(2a matrícula\)")
  * [English](en/studies/academic-management/administrative-procedures/incoming-enrolment-2nd-time.md "Incoming enrolment \(2nd time\)")
  * [Español](es/estudios/secretaria/tramites/matricula-incoming-2a-matricula.md "Matrícula Incoming \(2ª matrícula\)")
...
[ __](ca/estudis/secretaria/tramits/matricula-incoming-2a-matricula.md)
...
# Matrícula Incoming (2a matrícula)

## Esteu aquí

[Inici](ca.md) » [Estudis](ca/estudis.md) »
[Secretaria](ca/estudis/secretaria.md) »
[Tràmits](ca/estudis/secretaria/tramits.md) » Matrícula Incoming

Per tal de poder-te matricular el 2n semestre d'estada a la FIB, hauràs
d'enviar un correu electrònic a  confirmant els cursos que vols fer, tenint en
compte que hi ha un acord acadèmic signat prèviament i, per tant, no haurien
d'haver-hi gaires canvis. Tot i així, si vols fer algun canvi hauràs de tenir
en compte que és obligatori complir amb els requisits de les assignatures i
comprovar que no hi ha solapaments entre elles. En cas de solapament, no
s'acceptaran els canvis.

L'ordre de matrícula pel 2n semestre es calcula segons el rendiment acadèmic
de l'estudiant/a durant el seu primer semestre a la FIB, per aquest motiu a la
matrícula del 2n semestre no es pot garantir plaça a les assignatures
acordades.

L'estudiantat que durant el 2n semestre hagi de defensar el projecte final de
carrera (TFG/TFM) haurà de fer la inscripció del projecte abans de la data
límit per matricular-lo.

Consulta el [calendari acadèmic](ca/estudis/secretaria/calendaris-
academics.md) per saber quan comencen les classes del 2n semestre.

Tràmit en línia

[e-Secretaria](estudiants.md)

  * [Quan](ca/estudis/secretaria/tramits/matricula-incoming-2a-matricula.md)
  * [ Dirigit a](ca/estudis/secretaria/tramits/matricula-incoming-2a-matricula.md)
  * [ Taxes](ca/estudis/secretaria/tramits/matricula-incoming-2a-matricula.md)
  * [ Contacte](ca/estudis/secretaria/tramits/matricula-incoming-2a-matricula.md)
...
Estudiantat d'intercanvi que ha estat matriculat el quadrimestre anterior a la
FIB.
