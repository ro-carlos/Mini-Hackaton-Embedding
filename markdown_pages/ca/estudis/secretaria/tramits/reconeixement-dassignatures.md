[Vés al contingut](ca/estudis/secretaria/tramits/reconeixement-
dassignatures.md)
...
[ __](ca/estudis/secretaria/tramits/reconeixement-dassignatures.md)
...
[Secretaria](ca/estudis/secretaria.md) »
[Tràmits](ca/estudis/secretaria/tramits.md) » Reconeixement d'assignatures

El reconeixement és l’acceptació, en un estudi oficial de la UPC, dels crèdits
que havent estat obtinguts en uns ensenyaments oficials, a la mateixa UPC o en
qualsevol altra universitat, són computats a l’efecte de l’obtenció d’un títol
oficial. Aquest reconeixement implica l’establiment d’una equivalència pel que
fa a competències específiques i/o transversals i a càrrega de treball per a
l’estudiant entre assignatures de plans d’estudis conduents a l’obtenció de
títols oficials.

El reconeixement s’ha de fer sempre a partir de les assignatures cursades en
els estudis d’origen, mai a partir d’assignatures convalidades, adaptades o
reconegudes prèviament.
...
## Com realitzar la sol·licitud?
  ...
  2. L’estudiant haurà de registrar una [Sol·licitud de reconeixement/convalidació d'assignatures per altres estudis universitaris](ca/Tramits/Sol-licitud_reconeixement_convalidacions_assignatures.md) a la seu electrònica de la UPC
...
Una vegada completat el procés de signatura, l’aplicació informarà que s'està
processant el tràmit. Quan l’aplicació informi que el tràmit s'ha completat
correctament, es podrà descarregar el rebut de registre del tràmit. La no
recepció del rebut acreditatiu significa que la Universitat Politècnica de
Catalunya no ha rebut la sol·licitud. Per tant, el document es tindrà per no
presentat a tots els efectes.
...
Amb aquest codi, si es necessita, a l'apartat d’[autoservei de documents de la
Seu Electrònica UPC](ca/sobre-la-seu/eines/autoservei-de-documents.md), es
podrà obtenir una còpia autèntica de la documentació presentada.
...
licitud_reconeixement_convalidacions_assignatures.md)
  ...
  * [Quan](ca/estudis/secretaria/tramits/reconeixement-dassignatures.md)
  * [ Dirigit a](ca/estudis/secretaria/tramits/reconeixement-dassignatures.md)
  * [ Documentació necessària](ca/estudis/secretaria/tramits/reconeixement-dassignatures.md)
  * [ Normativa associada](ca/estudis/secretaria/tramits/reconeixement-dassignatures.md)
  * [ Taxes](ca/estudis/secretaria/tramits/reconeixement-dassignatures.md)
  * [ Contacte](ca/estudis/secretaria/tramits/reconeixement-dassignatures.md)
...
que han estat admesos a la FIB, i provenen d'altres centres de la UPC, o bé
d'altres universitats espanyoles o estrangeres.
...
En el cas dels estudiants que vulguin reconèixer estudis universitaris fets a
l'estranger, els documents acadèmics han de ser oficials, originals i expedits
per les autoritats competents, i han d'estar [legalitzats per via
diplomàtica](sga/ca/expedient/LegalitzacioDocuments/LegalitzacioTraduccioDocumentsEstrangers.md
"legalització via diplomàtica"). Així mateix, tots han d'anar acompanyats de
la traducció oficial al castellà o al català.

Documents:

![PDF icon](/modules/file/icons/application-pdf.png) [Instància de
reconeixement
d'assignatures](sites/fib/files/tramits/instancia_reconeixements_assignatures_0.pdf.md
"instancia_reconeixements_assignatures.pdf")

[Normativa Acadèmica dels Estudis de Grau i
Màster](sga/ca/normatives/NormativesAcademiques/NormativesAcademiques.md)

Consulta el [decret de preus](sga/ca/matricula/preus/decret-de-preus-
publics.md)
...
[Configuració de privadesa](ca/estudis/secretaria/tramits/reconeixement-
dassignatures.md)
