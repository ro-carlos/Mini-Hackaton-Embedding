...
informatica/matricula.md)
  ...
  * [Català](ca/estudis/masters/master-en-innovacio-i-recerca-en-informatica/matricula.md "Matrícula")
  * [English](en/studies/masters/master-innovation-and-research-informatics/enrolment.md "Enrolment")
  * [Español](es/estudios/masteres/master-en-innovacion-e-investigacion-en-informatica/matricula.md "Matrícula")
...
innovacio-i-recerca-en-informatica.md) » Matrícula
...
__Per poder matricular-te del màster com a nou estudiant, prèviament s'ha
de**tramitar l'admissió al màster (preinscripció)**. Consulta la informació
relativa a l'admissió al **[web de màsters FIB](ca.md)**.

__La matrícula a la UPC és**quadrimestral** , es fa dues vegades per curs
acadèmic (febrer i juliol).

#### [Estudiants de nou accés](ca/estudis/masters/master-en-innovacio-i-
recerca-en-informatica/matricula.md)

#### La matrícula és el contracte entre tu i la Universitat. Un cop t'hagis
matriculat, has de fer el pagament
  ...
  * Aquest contracte obliga la UPC a prestar-te els serveis previstos i a tu a pagar-los, a seguir-los i a respectar les **[normatives](sga/ca/normatives/NormativesAcademiques/NormativesAcademiques.md)** com a estudiant de la UPC.

#### La matrícula per als estudiants de nou accés és en línia.

  * La matrícula dels estudiants nous a la UPC es fa **en línia via[e-Secretaria](apl/home_estudiants.php.md)**.
  * La matrícula s’ha de formalitzar el **dia i l’hora assignats.**

### Llistat d'Admissió

[Resolució admissió 2024-2025 quadrimestre de
primavera](sites/fib/files/documents/estudis/resolucio-miri-2024-2.pdf.md)
(català, espanyol, anglès)

### Quan t’has de matricular?

  * **5 de febrer****de 2025** a les**10.00 h**

### On t'has de matricular?

La matrícula d'estudiants de nou accés es fa **en línia
via[e-Secretaria](apl/home_estudiants.php.md)**

### Idioma

Els candidats hauran d'acreditar el seu domini de l'anglès, amb un nivell
mínim de **B2** al [Marc Comú Europeu de Referència pels
Idiomes](wiki/Common_European_Framework_of_Reference_for_Languages.md) (o
equivalent).
...
### Documentació necessària per a la matricula
  ...
  * **Certificat** de coneixement d'Anglès (mínim: B2 del [Marc Comú Europeu de Referència pels Idiomes](wiki/Common_European_Framework_of_Reference_for_Languages.md)).

  * **Original** del **títol** que dóna accés al Máster o bé el **comprovant** d’haver fet efectiu el pagament dels drets d’expedició. En cas d'estudis realitzats a l'estranger seran necessaris l’original i del document emès per la universitat o institució a on s’hagi obtingut el títol o per l’autoritat del país competent en la matèria. Aquest document ha d’acreditar que el títol té una durada de com a mínim 3 anys, i què permet accedir a estudis de postgrau (màster) a aquell país. Si això no és possible, s’haurà d’indicar a quin nivell superior d’estudis dóna accés aquest títol.
...
**Important:** Tots els documents emesos fora d’Espanya o a països no
hispanoparlants han d’estar
[**traduïts**](sga/ca/expedient/LegalitzacioDocuments/LegalitzacioTraduccioDocumentsEstrangers.md)
al castellà o català. Els documents emesos a països que no pertanyen a l’Espai
Europeu d’Educació Superior han d’estar segellats i
**[legalitzats](sga/ca/expedient/LegalitzacioDocuments/LegalitzacioTraduccioDocumentsEstrangers.md)**
pel departament governamental corresponent.

### Horaris i grups

En el moment de fer la matricula hauràs d'escollir les assignatures que vols
cursar en aquell semestre, i a quin grup hi vols anar.

  

#### [Estudiants d’altres cursos](ca/estudis/masters/master-en-innovacio-i-
recerca-en-informatica/matricula.md)

Tota la informació la trobaràs al tràmit [matrícula estudiants de
màster](ca/estudis/secretaria/tramits/matricula-de-masters.md).
