[Vés al contingut](ca/estudis/beques-i-ajuts.md)
  ...
  * [Català](ca/estudis/beques-i-ajuts.md "Beques i Ajuts")
  * [English](en/studies/grants-and-financial-aid.md "Grants and Financial Aid")
  * [Español](es/estudios/becas-y-ayudas.md "Becas y Ayudas")
...
[ __](ca/estudis/beques-i-ajuts.md)
...
[Inici](ca.md) » [Estudis](ca/estudis.md) » Beques i Ajuts
...
Hi ha diverses maneres de finançar els teus estudis a la UPC. La Universitat i
altres entitats ofereixen beques, ajuts, beques de mobilitat i préstecs.

## Beques específiques de la FIB

__

### **Beques de graus FIB**

Consulta les [beques específiques de Graus](ca/estudis/beques-i-ajuts/beques-
graus.md) que poden aplicar estudiants de la FIB.

__

### **Beques dels Màsters FIB**

Consulta les [Beques específiques dels Màsters](ca/beques-i-ajuts.md) que
poden aplicar estudiants de la FIB.

Cal haver sol·licitat l'admissió al màster corresponent per acollir-se a la
beca.
...
L'inLab FIB ofereix beques dins del [programa de formació inLab
Talent](ca/programa-talent.md) per a estudiants de Grau i Màsters. Aquestes
beques consisteixen en ajuts econòmics vinculats a la col·laboració en
projectes de R+D+i amb empreses del sector TIC.

## Beques i ajuts als estudis UPC

__

### **Beques i ajuts UPC**

[Informació completa sobre beques i ajuts a la UPC de Graus i Màsters
Universitaris](aprendre/beques-ajuts.md).

__

### **Pràctiques i/o col·laboracions**

Consulta el llistat de convocatòries obertes de [Beques
d'Aprenentatge](CONV/indexBeques/beaList.md) en unitats de la UPC. (intranet)

## Ajuts personal docent de la FIB

__

### **Ajuts per a la realització de projectes de millora i innovació docent**

Amb la finalitat de donar suport al professorat que inicia projectes de
millora i innovació docent en el marc de l’activitat docent realitzada a la
Facultat d’Informàtica de Barcelona (FIB), s’obre una convocatòria d’ajuts per
a projectes de millora i innovació educativa que permetin incrementar els
aprenentatges de l’estudiantant i recollir evidències sobre la seva pertinença
i efectivitat. Consulta la [resolució
definitiva](sites/fib/files/resolucio_definitiva_ajuts_innovacio_docent_fib_2024_copia_autentica_catala.pdf.md).
...
[Configuració de privadesa](ca/estudis/beques-i-ajuts.md)
