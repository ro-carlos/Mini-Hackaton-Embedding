[Vés al contingut](ca/estudis/graus/vols-estudiar-un-grau/acces-als-
estudis.md)
...
[ __](ca/estudis/graus/vols-estudiar-un-grau/acces-als-estudis.md)
...
[Vols estudiar un grau?](ca/estudis/graus/vols-estudiar-un-grau.md) » Accés
als estudis

La UPC és una universitat pública i per tant l'accés es fa a través de
l'Oficina de preinscripció de la Generalitat de Catalunya.

Trobaràs tota la informació (vies d'accés, preinscripció, calendari, etc) al
[Canal Universitat de la GenCat](ca/preinscripcions.md).

Et deixem els**codis de preinscripció** dels nostres graus:

  * 31059 - Grau en Enginyeria Informàtica ([fitxa informativa GenCat](ca/detalls/oferta/1456-Enginyeria-Informatica.md))
  * 31089 - Grau en Ciència i Enginyeria de Dades ([fitxa informativa GenCat](ca/detalls/oferta/4207-Ciencia-i-Enginyeria-de-Dades.md))
  * 31106 - Grau en Intel·ligència Artificial ([fitxa informativa GenCat](ca/detalls/oferta/4838-Intelligencia-Artificial.md))
  * 31116 - Grau en + Màster Universitari en Enginyeria Informàtica (PARS: Enginyer/a informàtic/a) ([fitxa informativa GenCat](ca/detalls/oferta/4990-Enginyeria-Informatica-Grau-en-Master-Universitari-en-Enginyeria-Informatica-PARS-Enginyer-a-Informatic-a.md))
  * 91917 - Bachelor's degree in Bioinformatics (interuniversitari UPC-UPF-UAB-UB) ([fitxa informativa GenCat](ca/detalls/oferta/5141-Bioinformatics-Taught-in-English.md))

### Ponderacions d'assignatures de la fase específica de PAU 2024

Les ponderacions actualitzades es poden consultar al [Canal d'Universitats de
la GenCat.](ca/preinscripcions/sobre-preinscripcio/ponderacions.md)
...
Les **ponderacions del programa successiu** (PARS: Enginyer/a informàtic/a -
Grau en + Màster Universitari en Enginyeria Informàtica) són les mateixes del
...
Es pot **accedir als estudis de la FIB** després d'haver cursat:
  ...
  * [Batxillerat](ca/graus/acces-i-admissio/vies-dacces/batxillerat.md)
  * [Cicles Formatius de Grau Superior ](ca/graus/acces-i-admissio/vies-dacces/cfgs.md)
  * [Proves d'accés per als més grans de 25 anys i de 45 anys](ca/graus/acces-i-admissio/vies-dacces/acces-als-estudis-de-grau-per-a-mes-grans-de-25-i-45-anys.md)
  * [Canvi d'universitat i/o estudis universitaris oficials espanyols ](ca/estudis/graus/vols-estudiar-un-grau/acces-als-estudis.md)
  * [Estudiants que han cursat estudis universitaris estrangers ](ca/estudis/graus/vols-estudiar-un-grau/acces-als-estudis.md)

## Canvi d’universitat i/o d’estudis universitaris oficials espanyols

L’accés per canvi d’universitat i/o d’estudis universitaris oficials espanyols
implica en tots els casos el tancament de l’expedient d’origen. En
conseqüència, no poden accedir en cap cas per aquesta via els estudiants
titulats o que estan en disposició d’obtenir el títol, ni els que volen
simultaniejar estudis o cursar un itinerari conduent a una doble titulació.

### Qui pot demanar l’accés a estudis de la UPC?

Els estudiants que volen canviar d’universitat i/o d’estudis universitaris
oficials espanyols poden sol·licitar l’admissió directament a un centre o
estudi sense haver d’obtenir-ne la plaça mitjançant el procés de
preinscripció, si se’n reconeix un mínim de 30 ECTS, d’acord amb el que
estableix l’apartat 4.1 de la [normativa acadèmica dels estudis de Grau i
Màster](sga/ca/shared/fitxers-normatives/NormativesAcademiques/NAGRAMA.md)
(NAGRAMA), i si compleixen els criteris que s’especifiquen a continuació.
...
### Requisits per a l’admissió als estudis
  ...
  * No estar afectat per les normes de permanència als estudis d’origen, si aquests s’han cursat a la UPC. Un estudiant declarat no apte en aplicació dels apartats 5.4 i 5.5 de la Normativa de permanència dels estudis de grau de la UPC ([NAGRAMA](sga/ca/shared/fitxers-normatives/NormativesAcademiques/NAGRAMA.md)) es considera que està afectat durant els dos anys següents a la seva desvinculació. Si ha estat desvinculat en aplicació de l’apartat 5.8, es considera que està afectat durant el temps de desvinculació que ha resolt el rector o rectora.

Si no es reuneixen aquests requisits, s’ha d’obtenir la plaça pel procés de
preinscripció.

### Criteris de selecció

Les sol·licituds d'admissió presentades es prioritzaran d'acord amb els
criteris següents:
...
### Període de presentació de sol·licituds
  ...
  * Del 14 de juny de 2024 al 15 de juliol de 2024.
  * La resolució i la data de la mateixa es farà pública al [tràmit d'accés als estudis](ca/estudis/secretaria/tramits/sollicitud-dacces-canvi-destudis-centre-o-universitat-amb-reconeixement.md).

### Com presentar la sol·licitud

#### Documentació necessària

  * Si ets estudiant de la UPC 
    * còpia del DNI (en vigor)
    * còpia de l'expedient amb nom de l'assignatura i darrera convocatòria
    * Ompliu la [sol·licitud de canvi de centre o estudis i reconeixement d'assignatures](sites/fib/files/tramits/canvi_de_centre_i_reconeixement_dassignatures_0.pdf.md)
  * Si no ets estudiant de la UPC 
    ...
    * còpia del DNI
    * còpia compulsada del document d'accés a la Universitat on consti la nota d'accés
    * Ompliu la [sol·licitud de canvi de centre o estudis i reconeixement d'assignatures](sites/fib/files/tramits/canvi_de_centre_i_reconeixement_dassignatures_0.pdf.md)

#### Tramitar la sol·licitud

La sol·licitud d'admissió es presentarà de forma electrònica amb el tràmit
[Sol·licitud d’accés per canvi d’estudis, centre o universitat, amb
reconeixement](ca/estudis/secretaria/tramits/sollicitud-dacces-canvi-destudis-
centre-o-universitat-amb-reconeixement.md)

Si sou admesos/admeses per aquesta via haureu d'abonar les taxes de trasllat
d'expedient d’acord amb la informació [del
tràmit](ca/estudis/secretaria/tramits/sollicitud-dacces-canvi-destudis-centre-
o-universitat-amb-reconeixement.md).

## Estudiants que han cursat estudis universitaris estrangers

Els estudiants que hagin cursat els estudis universitaris a l'estranger hauran
de sol·licitar la convalidació d'aquests estudis per poder-se incorporar en
una universitat espanyola.

El procediment d'accés a la Universitat variarà en funció del nombre de
crèdits convalidats:
...
#### Documentació necessària
  ...
  * [Declaració d’equivalència de notes mitjanes d’estudis universitaris realitzats a centres estrangers.](equivalencia-de-notas-medias-de-estudios-universitarios-realizados-en-centros-extranjeros.md)
...
Els documents acadèmics hauran de ser oficials, originals i expedits per les
autoritats competents, i legalitzats per via diplomàtica.

Quan les fotocòpies siguin compulsades i legalitzades per la representació
diplomàtica o consular a Espanya del país de la persona que realitza la
sol·licitud, no serà necessari acompanyar-les dels documents originals. Així
mateix, tots hauran d'anar acompanyats de la traducció oficial al castellà o
al català.

[Legalització dels documents expedits a
l'estranger](sga/ca/expedient/LegalitzacioDocuments.md)
...
[Configuració de privadesa](ca/estudis/graus/vols-estudiar-un-grau/acces-als-
estudis.md)
