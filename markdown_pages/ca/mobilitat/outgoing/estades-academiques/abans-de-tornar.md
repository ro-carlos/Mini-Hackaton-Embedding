[Vés al contingut](ca/mobilitat/outgoing/estades-academiques/abans-de-
tornar.md)
  ...
  * [Català](ca/mobilitat/outgoing/estades-academiques/abans-de-tornar.md "Abans de tornar")
  * [English](en/mobility/outgoing/study-abroad/you-return.md "Before you return")
  * [Español](es/movilidad/outgoing/estancias-academicas/antes-de-regresar.md "Antes de regresar")
...
acadèmiques](ca/mobilitat/outgoing/estades-academiques.md) » Abans de tornar
...
La universitat d'acollida t'ha d'emplenar i signar el **certificat d’estada**
amb les dates reals de la teva estada acadèmica. **Aquest certificat no serà
vàlid si la data de signatura del responsable de la universitat d'acollida és
prèvia a la data de fi de la teva estada.** El document el trobaràs a la teva
e-secretaria>mobilitat>estada mobilitat. Un cop signat l'hauràs de penjar a
l'e-secretaria.

NO S'ACCEPTA el certificat d'estada propi de la universitat d'acollida.

Aquest certificat és imprescindible per tancar l'expedient de mobilitat i per
justificar la beca rebuda, altrament hauràs de retornar els diners de la beca
(en el cas de ser beneficiari de beca).

### 2\. Fes-nos arribar el transcript of records

La universitat d'acollida ha d'enviar el certificat de notes en format digital
a

NO S'ACCEPTEN TRANSCRIPTS ENVIATS PELS ALUMNES.

En el cas d'universitats partner que informin els estudiants que no envien el
transcript a la universitat de l'estudiant, caldrà que ens feu arribar les
credencials de la Intranet des de la qual teniu accés al trasncript per tal
que ens els puguem descarregar.

Tingues en compte que el certificat de notes ha de correspondre exactament amb
les assignatures fixades a l'acord acadèmic.
...
[Configuració de privadesa](ca/mobilitat/outgoing/estades-academiques/abans-
de-tornar.md)
