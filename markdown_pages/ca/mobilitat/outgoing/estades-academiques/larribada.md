[Vés al contingut](ca/mobilitat/outgoing/estades-academiques/larribada.md)
  ...
  * [Català](ca/mobilitat/outgoing/estades-academiques/larribada.md "A l'arribada")
  * [English](en/mobility/outgoing/study-abroad/when-you-arrive.md "When you arrive")
  * [Español](es/movilidad/outgoing/estancias-academicas/tu-llegada.md "A tu llegada")
...
[ __](ca/mobilitat/outgoing/estades-academiques/larribada.md)
...
[Outgoing](ca/mobilitat/outgoing.md) » [Estades
acadèmiques](ca/mobilitat/outgoing/estades-academiques.md) » A l'arribada
...
## Què he de fer en arribar a la universitat d'acollida?

**Recorda:** Fes servir sempre el correu  per comunicar qualsevol incidència
que es produeixi durant la teva estada.

### 1\. Fes signar el certificat d'arribada

A l'arribada a la universitat d'acollida, t'has de posar en contacte
ràpidament amb el responsable de Relacions Internacionals de la universitat
per tal d'obtenir el **certificat d'arribada**. A la teva
e-secretaria>mobilitat>estada mobilitat, trobaràs els models per emplenar
d'aquest document.

NO S'ACCEPTA el certificat d'arribada propi de la universitat d'acollida.

El certificat signat l'has de pujar a l'e-secretaria durant **els 15 primers
dies** des de l'arribada a destinació.

Si gaudeixes de beques d'altres institucions, és possible que hagis d'enviar
més còpies del certificat d'arribada.

### 2\. Matricula't

Algunes universitats tenen un procés de matrícula semblant a la FIB i t'hauràs
de matricular quan arribis, mentre que d'altres et demanaran fer la matrícula
uns dies abans de l’examen final de les assignatures. Recorda que no has de
pagar les assignatures a destí perquè ja ho has fet abans a la FIB.

### 3\. Actualitza l'acord acadèmic,_Learning Agreement_ , si escau

L'acord acadèmic, decidit i signat abans de marxar, pot variar segons les
circumstàncies que trobis a l’arribada a la universitat d'acollida
(assignatures tancades, solapaments horaris, idioma diferent del previst,
...). Informa'ns ràpidament d'aquesta situació i proposa'ns una llista
d'assignatures candidates que serveixin per substituir les que no pots cursar.
**Has d'esperar a tenir el vistiplau de la FIB per a fer els canvis. En cas de
no fer-ho, no podràs reconèixer els cursos que hagis canviat sense
autorització.**

Un cop tinguis els canvis autoritzats, omple el document de canvis a l'acord
acadèmic que trobaràs a continuació, el signes i demanes que te'l signi i
segelli la universitat d'acollida. Un cop signat per les tres parts l'hauràs
de penjar a la teva e-secretaria juntament amb el Learning Agreement inicial
(un únic pdf).

  * [Canvis a l'acord acadèmic](sites/fib/files/documents/changes_la_erasmus_studies_1819_en.docx.md) per a mobilitat dins del programa Erasmus+
  * [Canvis a l'acord acadèmic](sites/fib/files/documents/mobilitat/canvis_la_tpnap.pdf.md) per a estades a destinacions Erasmus+ TPNAP ([Tercers països no associats al programa](sga/ca/Beques/beques-per-a-la-mobilitat/ajutsmobilitaterasmus-1/1aconvoc_sms_ka131_tpnap_24-25_folder/TercersPaisosNoAssociatsPrograma.md))
  * [Canvis a l'acord acadèmic](sites/fib/files/documents/changes_la_1819_no_erasmus.docx.md) per a mobilitat fora del programa Erasmus+

Atenció!: abans de signar un document de canvis és imprescindible que l'acord
inicial, pactat abans de marxar, estigui signat i segellat per la universitat
de destí.
...
[Configuració de privadesa](ca/mobilitat/outgoing/estades-
academiques/larribada.md)
