[Vés al contingut](ca/mobilitat/incoming/estada-en-practiques.md)
  ...
  * [Català](ca/mobilitat/incoming/estada-en-practiques.md "Estada en pràctiques")
  * [English](en/mobility/incoming/research-visit.md "Research Visit")
  * [Español](es/movilidad/incoming/estancia-en-practicas.md "Estancia en prácticas")
...
[ __](ca/mobilitat/incoming/estada-en-practiques.md)
...
[Incoming](ca/mobilitat/incoming.md) » Estada en pràctiques

  * [Estada acadèmica](ca/mobilitat/incoming/estada-academica.md)
  * [Estada en pràctiques](ca/mobilitat/incoming/estada-en-practiques.md)

__S’adreça a estudiants que volen fer una estada de recerca en algun dels
departaments, laboratoris, instituts o grups de recerca de la UPC.

__L’estada en pràctiques no és compatible amb una estada acadèmica en la qual
s’estigui matriculat d’assignatures a la UPC.

__El període de pràctiques no pot incloure el mes d’agost, atès que la UPC
tanca.

__No cal que la FIB tingui un conveni bilateral amb la universitat de la qual
prové l’estudiant que vol fer les pràctiques.

__Aquestes pràctiques no són remunerades.

__**En cap cas l’estudiant podrà iniciar l’estada sense que la unitat que
l’acull disposi de tota la documentació requerida.**

Per gaudir d'una estada en pràctiques, l'estudiant ha de seguir els passos
següents:

### 1\. Obtenir una carta d'invitació

Contactar amb un professor d’algun dels [departaments, laboratoris o grups de
recerca](ca/recerca.md) de la FIB per obtenir una carta d’invitació.

### 2\. Traineeship agreement

Emplenar un _traineeship agreement_ (Erasmus+ o el que correspongui), que s’ha
de negociar amb el professor que l’acollirà. Requereix la signatura de
l’estudiant i de la institució d’origen (3 exemplars originals).

### 3\. Assegurança obligatòria

Aportar una assegurança d'accidents, de repatriació i de responsabilitat
civil. La UPC té conveni amb [On Campus](seguros/oncampus-estudia.md), de
manera que els estudiants que vinguin a fer una estada de recerca, si no
disposen de cap assegurança podrien contractar aquesta.

### 4\. Estar matriculat a la institució d'origen

Aportar la matrícula de la universitat d'origen, per demostrar que és
estudiant durant el període que estarà en pràctiques a la UPC.
...
[Configuració de privadesa](ca/mobilitat/incoming/estada-en-practiques.md)
