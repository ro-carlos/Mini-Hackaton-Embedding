[Vés al contingut](ca/empresa/fib-visiona.md)
  ...
  * [Català](ca/empresa/fib-visiona.md "FIB Visiona")
  * [English](en/companies/fib-visiona.md "FIB Visiona")
  * [Español](es/empresa/fib-visiona.md "FIB Visiona")
...
[Inici](ca.md) » [Empresa](ca/empresa.md) » FIB Visiona
...
FIB Visiona treballar per connectar el talent FIBer que busca avançar a la
seva carrera professional amb empreses i organitzacions punteres d'arreu del
món. Organitza un conjunt d'activitats (presentacions, conferències, estands
d'empreses, recollida de currículums i entrevistes, etc.) amb l'objectiu
d'oferir un ampli ventall d'opcions a l'hora d'iniciar-se o avançar al món
laboral.

L'esdeveniment més destacat organitzat per FIB Visiona, és la fira de treball
que té com a objectiu connectar empreses amb els estudiants i les estudiantes
de les diferents titulacions.  
...
per els estudiants, que tenen l'oportunitat així de contactar directament amb
...
[Configuració de privadesa](ca/empresa/fib-visiona.md)
