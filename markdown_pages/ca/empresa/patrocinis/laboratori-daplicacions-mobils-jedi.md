[Vés al contingut](ca/empresa/patrocinis/laboratori-daplicacions-mobils-
jedi.md)
  ...
  * [Català](ca/empresa/patrocinis/laboratori-daplicacions-mobils-jedi.md "Laboratori d'aplicacions mòbils Jedi")
  * [English](en/companies/sponsorship/jedi-mobile-apps-lab.md "Jedi Mobile Apps Lab")
  * [Español](es/empresa/patrocinios/laboratorio-de-aplicaciones-moviles-jedi.md "Laboratorio de aplicaciones móviles Jedi")
...
[ __](ca/empresa/patrocinis/laboratori-daplicacions-mobils-jedi.md)
...
# Laboratori d'aplicacions mòbils Jedi

## Esteu aquí

[Inici](ca.md) » [Empresa](ca/empresa.md) »
[Patrocinis](ca/empresa/patrocinis.md) » Laboratori d'aplicacions mòbils Jedi

  * [Laboratori d'aplicacions mòbils Jedi](ca/empresa/patrocinis/laboratori-daplicacions-mobils-jedi.md)
  * [Laboratori Social Point](ca/empresa/patrocinis/laboratori-social-point.md)

El laboratori d'aplicacions mòbils, es troba ubicat al soterrani de l'edifici
C6. S'ha finançat mitjançant [un projecte de micro-
finançament](project/laboratori-d-aplicacions-mobils.md) dins el marc del
programa SumaUPC i ha comptat amb un total de 52 co-finançadors entre empreses
i particulars. La campanya de Crowdfunding realitzada mitjançant la plataforma
Goteo es va realitzar des de l'octubre de 2013 fins al gener de 2014.  
  
El Laboratori ha estat apadrinat per la JEDI - Junior Empresa, i gràcies a
l'import recollit compta amb 8 estacions de treball iMac, amb una garantia
estesa a tres anys. Una d'aquestes 8 estacions de treball, ha estat apadrinada
per l'empresa JES Serveis Informàtics.  
  
Les estacions de treball estan a disposició dels estudiants de la facultat per
a que també es puguin formar en el desenvolupament d'aplicacions per a iOS
(iPads, iPhones,...) completant d'aquesta manera, la possibilitat de
desenvolupar aplicacions per a totes les plataformes mòbils disponibles
actualment.  
  
Els titulats de la FIB en situació d'atur disposen d'unes hores d'equipament
per a la seva auto-formació en el desenvolupament d'Apps. També es cedeix el
Laboratori durant els períodes no lectius per a la realització de cursos a
persones en situació d'atur, ONGs i a entitats socials sense ànim de lucre
prèvia sol·licitud i aprovació.  
  
Volem que aquest Laboratori contribueixi a formar bons professionals en totes
les plataformes mòbils, obri portes als nostres estudiants en la incorporació
al mercat laboral, contribueixi a satisfer la demanda de professionals del
sector de les aplicacions mòbils i que aquest sector esdevingui un dels motors
d'innovació del nostre país.  
  
Es va inaugurar el dia 2 d'abril de 2014 amb la presència del rector de la
Universitat Politècnica de Catalunya (Dr. Enric Fosas), la degana de la
Facultat d'informàtica de Barcelona (Sra. Núria Castell), el director de
l'inLab (Sr. Josep Casanovas), el president de JEDI (Sr. Xavier Bustamante) i
el _Product Marketing Director_ de Red Hat (Sr. Erik Brieva).

El curs 2019-2020 (setembre 2019) l'aula es deixa d'utilitzar com espai de
treball amb iMac i es redissenya per cobrir noves necessitats.
...
[![](/sites/fib/files/images/empresa/logo-fib-alumni.gif)](index.md)

![](/sites/fib/files/images/empresa/logo-mobetia.png)

[![](/sites/fib/files/images/empresa/logo-qrquarking_bcnquark.jpg)](index.md)

![](/sites/fib/files/images/empresa/logo-incubio.png)

![](/sites/fib/files/images/empresa/logo-mybus.png)

[![](/sites/fib/files/images/empresa/logo-dexma.png)](index.md)

[![](/sites/fib/files/images/empresa/logo-informatics.png)](index.md)

[![](/sites/fib/files/images/empresa/logo-enide.png)](index.md)
...
[Configuració de privadesa](ca/empresa/patrocinis/laboratori-daplicacions-
mobils-jedi.md)
