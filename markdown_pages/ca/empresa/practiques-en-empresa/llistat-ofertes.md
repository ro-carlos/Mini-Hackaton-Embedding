[Vés al contingut](ca/empresa/practiques-en-empresa/llistat-ofertes.md)
  ...
  * [Català](ca/empresa/practiques-en-empresa/llistat-ofertes.md "Llistat ofertes")
  * [English](en/companies/industrial-practices/offers-list.md "Offers list")
  * [Español](es/empresa/practicas-en-empresa/listado-ofertas.md "Listado ofertas")
...
[ __](ca/empresa/practiques-en-empresa/llistat-ofertes.md)
...
[Inici](ca.md) » [Empresa](ca/empresa.md) » [Pràctiques en
empresa](ca/empresa/practiques-en-empresa.md) » Llistat ofertes
...
La borsa permet a l'estudiantat:
...
L'estudiantat no registrat només pot accedir a la informació pública,
consultant la descripció i localitat de les pràctiques publicades. Per accedir
a la resta de funcionalitats de la borsa cal estar registrat.

[Borsa de pràctiques en empresa](index.md)

  1. Per a registrar-te cal que accedeixis a la borsa amb el teu usuari UPC i, si compleixes els requisits acadèmics necessaris, ja pots començar a fer servir l'aplicatiu.
  2. Introdueix les teves dades al Perfil d’usuari

Des de la pestanya "Editar" del perfil d’usuari, pots modificar les teves
dades personals: nom, telèfon, NIF.  
Has d’informar obligatòriament dels camps Estudis, Àmbit i Jornada. També és
obligatori annexar el teu CV. **Fins que no omplis aquestes dades i annexis un
CV el teu perfil no serà visible** per a les empreses i no podràs presentar
candidatures a cap oferta. Es pot omplir voluntàriament el camp d’experiència
professional i preferències amb informació addicional o comentaris més enllà
del currículum.  
  
La darrera opció dins del perfil d’usuari és l’autorització a la difusió de
les dades personals i el CV a totes les empreses registrades. Només seran
visibles per a totes les empreses aquells estudiants que hagin donat aquesta
autorització.**La no autorització fa que només podran veure les dades de
l’estudiant les empreses a les quals presentis candidatura**.

## Preguntes freqüents

#### [Quins són els requisits per accedir a la borsa i realitzar pràctiques en
empreses?](ca/empresa/practiques-en-empresa/llistat-ofertes.md)

L’estudiantat que vulgui participar en una pràctica acadèmica externa ha de
complir:

**Estudiants de grau**

  * Haver superat 50% dels crèdits dels estudis que està cursant.
  * Estar matriculat d'assignatures o bé del TFG.
...
**Estudiants de màster**
  ...
  * Estar matriculat d'assignatures o bé del TFM.
  * Tenir assegurança escolar mentre el conveni sigui vigent.**** En el cas de majors de 28 anys, l'esmentada assegurança haurà de ser proporcionada pel propi estudiant.
  * No mantenir una relació contractual amb l'empresa en que es fan les pràctiques.

#### [M'he registrat a la Borsa però no veig cap
oferta](ca/empresa/practiques-en-empresa/llistat-ofertes.md)

**Fins que no omplis les dades personals i annexis un CV el teu perfil no
seràs visible** per a les empreses i no podràs presentar candidatures a cap
oferta. Trobaràs l'opció a la icona del menú superior dins l'opció "Perfil".
...
[Configuració de privadesa](ca/empresa/practiques-en-empresa/llistat-
ofertes.md)
