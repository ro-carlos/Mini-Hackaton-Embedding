[Vés al contingut](ca/empresa.md)
  ...
  * [Català](ca/empresa.md "Empresa")
  * [English](en/companies.md "Companies")
  * [Español](es/empresa.md "Empresa")
...
## Conèixer les necessitats de les empreses  
permet preparar més eficientment els professionals  
en les competències que la societat necessita

* * *

Creem coneixement per ajudar la societat a avançar amb iniciatives innovadores
i hem contribuït de forma significativa al desenvolupament de les Tecnologies
de la Informació del nostre país.

La col·laboració entre les organitzacions, les institucions i les empreses, i
la FIB, permet apropar interessos i compartir projectes, amb el valor afegit
de:

  * Garantir que els estudiants de la FIB tinguin un vincle directe amb les empreses del sector de les Tecnologies de la Informació que confien en nosaltres.
  * Formar estudiants per a l'adquisició de les competències professionals que necessiten les organitzacions.
  * Construir conjuntament projectes de recerca i innovació en les nostres àrees d'expertesa.
  * Possibilitar l'accés a xarxes nacionals i europees.
  * Construir una imatge social de prestigi a través de l'aliança universitat-empresa.

__

### Integració en el món laboral

  * [Pràctiques Acadèmiques Externes](ca/empresa/practiques-en-empresa.md): l'objectiu és completar la formació rebuda a la Universitat amb l'experiència professional dins de l'àmbit empresarial.
  * [FIB Visiona](ca/empresa/fib-visiona.md): fira d'empreses organitzat per l'estudiantat de la FIB que serveix de nexe, i punt de trobada, entre les empreses i els seus futurs professionals.
  * [Borsa de treball.](ca/empresa/borsa-de-treball.md)
  * [Programa inLab Talent.](programa-de-formacio-talent.md)

__

### Accions formatives

  * Seminaris d'empresa: conjunt de seminaris de curta durada impartits per professionals d'empreses de primer nivell en el sector de la informàtica, les telecomunicacions i els serveis.

__

### Networking

  * Participació en associacions que promouen projectes i relacions entre empreses com el Cluster per a la Innovació.
  * Participació anual a la [Festibity](index.md), gran festa de les Tecnologies de la Informació, organitzada per [FIB Alumni.](index.md)

__

### Patrocinis i acords de mecenatge

  * Patrocini d'aules informàtiques: 
    * [Laboratori d'aplicacions mòbils Jedi.](ca/empresa/patrocinis/laboratori-daplicacions-mobils-jedi.md)
    * [Laboratori Social point](ca/empresa/patrocinis/laboratori-social-point.md).
  * Càtedres d'empresa.

[![](/sites/fib/files/images/empresa/fibalumni-logo-peque.jpg)](index.md)

[![](/sites/fib/files/images/nttdata.png)](es.md)

[![](/sites/fib/files/images/empresa/thoughtworks.jpg)](es.md)

[![](/sites/fib/files/images/empresa/logo-vector-
seidor.jpg)](content/seidorweb/es.html.md)
...
[Configuració de privadesa](ca/empresa.md)
