[Vés al contingut](ca/la-fib/la-facultat/actes-academics.md)
  ...
  * [Català](ca/la-fib/la-facultat/actes-academics.md "Actes Acadèmics")
  * [English](en/fib/school/graduation-ceremony.md "Graduation Ceremony")
  * [Español](es/la-fib/la-facultad/actos-academicos.md "Actos Académicos")
...
[ __](ca/la-fib/la-facultat/actes-academics.md)
...
facultat.md) » Actes Acadèmics

## Actes de graduació

La Facultat organitza anualment els actes de graduació dels i de les
estudiants que cada curs finalitzen els seus estudis de grau o màster.

La cerimònia consisteix en un acte solemne, que presideix el degà de la FIB,
en què intervé un/a conferenciant i es demana a algun/a estudiant que
participi com a representant de la promoció que es gradua o titula.
L'estudiantat assistent rep, com a record, un diploma simbòlic emès per la
Facultat, que commemora la finalització dels seus estudis.

Si estàs interessat/ada en assistir-hi, consulta els apartats següents.

![](/sites/fib/files/images/acte-graduacio-gei-10nov-2022-2023_diplomes1.jpg)

## Propers Actes

### Acte de graduació del Grau en Enginyeria Informàtica 2024

  * __**Divendres 15 i 22 de novembre (a escollir)******
  * __18h a 20h
  * __Auditori Vèrtex, Campus Nord UPC
  * __Període d'inscripció:**del 21 d'octubre al 3 de novembre de 2024 mitjançant l'aplicació[Apunta't](index.md) **  
_(la inscripció per a cada sessió es tancarà un cop s’arribi al límit de
l’aforament de la sala)_

  * __Nombre màxim d’acompanyants: 2
  * __Import de l'entrada:
    * Estudiantat i PDI/PTGAS: 0 €
    * Acompanyants: 8 €
  * __**Requisits d'inscripció a l'acte** :

    * Haver obtingut el títol del GEI en el curs 2023-2024, o bé,
    * Tenir ja tots els crèdits matriculats per acabar la carrera en el curs 2023-2024, o
    * Tenir pendent de reconèixer els crèdits de mobilitat i/o convenis de pràctiques acadèmiques per acabar el grau, o
    * Tenir només pendent d'acreditar la Tercera Llengua  
**Important** :  
Si has acabat els estudis, però tens pagaments pendents, no t'hi pots
inscriure  
Si tens crèdits matriculats el curs 2024-2025, et correspon participar en
l'acte de graduació del l'any 2025.

**Entrega de premis**  
El premi al millor expedient del GEI es lliurarà en l'acte del dia 15 de
novembre i el premi FIB Alumni al millor TFG es lliurarà en l'acte del dia 22
de novembre. Si us plau, tingues-ho en compte en el moment de fer la
inscripció en cas de tenir opcions d'optar a algun d'aquests premis.

Contacta amb  per a qualsevol dubte.

## Què has de saber

[__](ca/la-fib/la-facultat/actes-academics.md)

###  [Abans de l'acte ](ca/la-fib/la-facultat/actes-academics.md)

[__](ca/la-fib/la-facultat/actes-academics.md)

###  [Durant l'acte ](ca/la-fib/la-facultat/actes-academics.md)

[__](ca/la-fib/la-facultat/actes-academics.md)

###  [Després de l'acte ](ca/la-fib/la-facultat/actes-academics.md)

### Abans de l'acte

#### **Qui pot participar**

  * S'informarà prèviament a totes aquelles persones que compleixin el requisits per participar de l'Acte. La comunicació es farà per email al correu d’estudiant UPC.
  * En el cas de no rebre el missatge, però penseu que reuniu els requisits per participar-hi, s’ha de contactar amb    

#### **Com fer la inscripció**

  * La inscripció s'ha de fer a través de l'aplicació[ **Apunta't**](index.md). L'estudiantat haurà d'omplir les seves dades i també les dels i de les acompanyants.
  * L’aplicació només mostrarà l'esdeveniment a l'estudiantat que compleixi els requisits, i per tant, es podrà inscriure.
  * En el cas de mobilitat reduïda o necessitats especials es pot indicar a la mateixa aplicació.  

#### **Acompanyants**

  * L'assistència d'acompanyants dependrà de l'aforament de què disposem, i s'infomarà a la mateixa inscripció.
  * Durant el període d’inscripció a l’acte, es podran fer canvis en el nom dels acompanyants a la mateixa aplicació [**Apunta't**](index.md).

#### **Pagament**

  * L'import de l'entrada s'indicarà en la informació del propi acte.
  * En el moment de fer la inscripció dels acompanyants, s'haurà de fer el pagament a través de l'aplicació [**Apunta't**](index.md), mitjançant targeta bancària.
  * Els menors de fins a 3 anys i que no ocupin un seient durant l'Acte de Graduació, no han de comprar entrada.  

#### **Política de devolucions**

En cas d'anul·lació de l'entrada, per sol·licitar la devolució de l'import, es
farà des de la mateixa aplicació [**Apunta't**](index.md) mentre estigui obert
el període d’inscripció. L'import es retornarà a través de la mateixa targeta
bancària amb que s'ha fet la compra.

No es faran devolucions sol·licitades fora del període d'inscripció.  

#### **Vestuari**

  * No es demana vestuari específic però per regla general els assistents van vestits de manera elegant i cuidada. 

### Durant l'acte

L'acte té una durada aproximada de dues hores que pot variar segons el nombre
d'assistents.  

#### **Arribada**

  * L'estudiantat que ha confirmat assistència serà convocat via email com a màxim un dia abans de l’acte. 
  * Per agilitzar el procés de registre, es recomana tenir preparada l’entrada (impresa en paper, o descarregada al mòbil).  

#### **On seuran els i les estudiants**

  * Una vegada tancat el període d'inscripció, s’assignarà un seient a cada estudiant titulat/ada. Es podrà consultar el lloc assignat 24 hores abans de l’acte a la mateixa aplicació [**Apunta't**](index.md) i en el moment de fer el registre el dia de l'acte.

#### **On seuran els i les acompanyants**

  * Les persones acompanyants seuran als espais reservats a tal efecte. No tindràn un seient assignat.  

#### **Desenvolupament de l'acte**

  * Quan accediu a la sala, trobareu al vostre seient la beca (banda) de la FIB que us haureu de posar abans de seure. 
  * S'inicia l'acte amb els parlaments de les personalitats.
  * A continuació es procedeix a lliurar les distincions als millors expedients i altres acreditacions.
  * Després us cridaran per ordre alfabètic i pujareu a l'escenari en ordre de crida pel costat dret mirant l’escenari i us dirigireu a la personalitat que us hagin assignat, que us lliurarà un **diploma***. Us girareu cap el públic i esperareu a que el fotògraf us facin la foto de grup. Després tornareu als vostres seients baixant de l'escenari pel costat contrari al que heu pujat. 
  * Finalitza l’acte amb unes paraules de cloenda del rector o la persona en qui delegui.  

_*** El diploma que es lliura no té cap validesa legal i en cap cas
substitueix el títol oficial. El títol oficial s'ha de sol·licitar
via**[**e-secretaria**](ca/estudis/secretaria/tramits/sollicitud-del-titol-i-
suplement-europeu-al-titol.md)._

#### **Drets d'imatge**

  * La Facultat d'Informàtica de Barcelona podrà utilitzar la imatge de tots els assistents a l'acte. L'assistència comporta l'acceptació de l'ús de la imatge.  

### Després de l'acte

#### **Imatges de l'acte**

  * Uns dies després de l'acte, l’estudiant rebrà un correu electrònic amb les instruccions per poder consultar i descarregar les fotografies oficials realitzades durant l'esdeveniment.  

#### **Photocall**

  * S'intentarà habilitar una zona de photocall per tal que pugueu fer-vos fotos amb els vostres companys i companyes.  
Si les pugeu a les xarxes socials, mencioneu-nos (@fib.upc) i les compartirem
al perfil de la FIB.
...
[Configuració de privadesa](ca/la-fib/la-facultat/actes-academics.md)
