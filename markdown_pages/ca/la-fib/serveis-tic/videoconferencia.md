[Vés al contingut](ca/la-fib/serveis-tic/videoconferencia.md)
...
[ __](ca/la-fib/serveis-tic/videoconferencia.md)
...
La videoconferència permet a un grup de persones ubicades en llocs diferents
dur a terme reunions com si estiguessin en la mateixa sala.

És una combinació tecnològica d'àudio, vídeo i xarxes de comunicació que
serveix perquè grups o individus puguin trobar-se cara a cara en un temps real
per interaccionar.

Una evolució o tipus de videoconferències són les webconference o conferències
web que descrivim al [servei Webconference](ca/la-fib/serveis-
tic/webconference.md).

La FIB disposa de dos equips de videoconferència Polycom HDX7000 amb protocol
H.323 i H.239 (doble canal de vídeo) situats a la [Sala de reunions](ca/la-
fib/espais/sales-de-presentacions/sala-de-reunions.md) i a l’Aula A6203. És un
maquinari especialitzat per tal de donar una bona qualitat d’imatge i so
adaptant-se a l’ampla de banda de la xarxa de comunicacions. Ambdós equips
tenen capacitat de [MCU](wiki/Unidad_de_Control_Multipunto.md) podent-nos
connectar fins a 3 llocs remots simultàniament. Gràcies al doble canal de
vídeo poden enviar o rebre contingut informàtic (PC, portàtil, ...)
paral·lelament a la imatge de la càmera.

## Utilització

Aquest servei és de pagament, amb un preu més reduït si ets membre de la
comunitat UPC i totalment gratuït per al professorat de la FIB.

La reserva de videoconferència implica fer reserva també de [la sala](ca/la-
fib/espais/sales-de-presentacions.md) on es farà. És molt recomanable fer una
prova per assegurar la compatibilitat dels equips i comprovar la viabilitat
del que es vol fer.

La FIBdóna suport a les videoconferències, per agititzar tot el procés és
convenient subministrar les dades necessàries en el moment de fer la reserva.

**Recomanacions per les persones que intervinguin en la videoconferència:**

  * Evitar, en la mesura que sigui possible, la roba de color molt clar, millor portar roba fosca.
  * Evitar els moviments bruscs i ràpids.
  * Si es vol fer una presentació amb el portàtil o PC, millor intentar usar una mida de lletra gran (32 punts mínim) i que hi hagi bastant contrast entre el fons escollit i les lletres.
...
## També et pot interessar
  ...
  * [MediaFib: Arxius de vídeo i esdeveniments en directe](ca/la-fib/serveis-tic/mediafib-arxius-de-video-i-esdeveniments-en-directe.md)
...
[Configuració de privadesa](ca/la-fib/serveis-tic/videoconferencia.md)
