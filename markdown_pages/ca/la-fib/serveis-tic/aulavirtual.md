[Vés al contingut](ca/la-fib/serveis-tic/aulavirtual.md)
...
[ __](ca/la-fib/serveis-tic/aulavirtual.md)
...
[Serveis TIC de la UPC](ca/contact/serveis-tic-de-la-upc.md)

  

La FIB ofereix el servei d'un ordinador virtual que poden fer servir
remotament amb els mateixos serveis que els dels laboratoris.

Aquest servei està accessible a l'URL:
[https://aulavirtual.fib.upc.edu](index.md)

## Utilització

Aulavirtual és una solució de virtualització d’escriptoris basada en el
software [RAVADA](index.md) i desenvolupada a la UPC com a software lliure.
Proporciona a l’usuari un escriptori virtual personal que s’executa al
servidor remot de manera independent al dispositiu (ordinador amb Windows, OS
X o Linux) des del qual es fa la connexió.

Aquest servei està dirigit als tots els estudiants i PDI de la FIB.

Actualment el servei 'aulavirtual' disposa de la imatge de Linux i la de
Windows, que hi ha disponibles als Laboratoris d'Informàtica.

**Accés al servei**  
Ens connectem a l'URL [https://aulavirtual.fib.upc.edu](index.md) i fem login
amb les nostres credencials de la UPC (les del Racó):

![Pantalla de login del servei
Aulavirtual](/sites/fib/files/images/fib/serveis-tic/ravada-presentacio1.png)

Veurem les plantilles que tenim disponibles. Actualment la imatge Linux dels
aularis.

![](/sites/fib/files/images/fib/serveis-tic/ravada-presentacio2_1.png)

Fem clic sobre el botó "Inicia".

![](/sites/fib/files/images/fib/serveis-tic/ravada-presentacio3.png)

Si fem clic ara sobre el botó "veure", el navegador ens demanarà obrir
l'aplicació Virt-viewer.
...
I se'ns obrirà una finestra amb la consola remota.

![Consola remota al virt-viewer](/sites/fib/files/images/fib/serveis-
tic/ravada-presentacio5.png)

**Com surto de visor?** La combinació de tecles és **SHIFT+F12**. Si passes
amb el ratolí a la part superior de la finestra, apareixerà un menú amb més
opcions.

![Menu superior del visor virt-viewer](/sites/fib/files/images/fib/serveis-
tic/ravada-presentacio6.png)

Em surt la finestra en negre i un cursor. Què està passant?

**![Conexio al linux d'aulavirtual amb
problemes](/sites/fib/files/images/ravada2_modo_grafico.png)**

Probablement la sessió X del Linux no s'ha engegat correctament. Podem
reiniciar la interfície gràfica així:

  * Anem a la consola de text amb la combinació de tecles Ctrl+Alt+F1
  * Iniciem sessió amb les nostres credencials, però en mode text
  * Escrivim: super xrestart restart (Aquesta comanda tornarà a engegar la interfície gràfica i l'obrirà automàticament)

​![comanda per reinicar el mode gràfic a
Linux](/sites/fib/files/images/ravada2_moto_texto.png)

Em surt un error "No se puede establecer una conexión ya que el equipo de
destino denegó expresamente dicha conexión"

![Connexió no
permesa](/sites/fib/files/images/ravada1_conexion_no_permitida.png)

La connexió des dels els laboratoris no està permesa. Trobaràs més informació
a l'apartat [**Des d'on em puc connectar?**](ca/la-fib/serveis-
tic/aulavirtual.md)

## FAQ's

__**Quantes instàncies puc engegar?**

Pots engegar una instància única de cada imatge disponible.

__**Quant de temps estarà disponible la meva imatge?**

La teva instància és volàtil, això vol dir que es destruirà quan aturis la
màquina. Això vol dir que els canvis es perden entre reinicis. També
s'esborrarà la màquina si no té activitat durant 12 hores. Recordeu desar les
vostres dades en dispositius externs o xarxa.

Igualment, per necessitats del servei, periòdicament es restauraran els
escriptoris al seu estat inicial des del servidor, perdent les dades que no
s'hagin emmagatzemat a la xarxa.

__**Des d'on em puc connectar?**

Pots connectar-te al servei des de l'exterior de la FIB mitjançant el servei
de VPN de la UPC, [UPCLink](ca/upclink.md). Aquí teniu la informació de com
accedir i configurar el servei al vostre ordinador: [UPCLink](ca/upclink.md).
No és possible connectar-se des dels laboratoris.

__**Quin software necessito per connectar-me?**

Per connectar-se a l'entorn Aulavirtual, cal un ordinador amb Windows, OS X o
Linux, en el qual poder instal·lar el visor [Virt-viewer](download.md)
(Windows i Linux) o [RemoteViewer](osx-client.html.md) (OS X). Aquest visor
ens permetrà capturar remotament la pantalla de la nostra instància al nostre
ordinador. A més a més, si instal·lem els drivers d'USB, també podrem
compartir dispositius remotament.

Instal·lació del client virt-viewer en Windows

Descarregar el visor [Virt-viewer](download.md) i els drivers USB per 32 o 64
bits, depenent del sistema operatiu:

  * Versió 32 bits: Visor: [https://releases.pagure.org/virt-viewer/virt-viewer-x86-11.0-1.0.msi](virt-viewer/virt-viewer-x86-11.0-1.0.msi.md)
  * Versió 64 bits: Visor: [https://releases.pagure.org/virt-viewer/virt-viewer-x64-11.0-1.0.msi](virt-viewer/virt-viewer-x64-11.0-1.0.msi.md)

Quan s'accedeixi a Ravada i es cliqui a "View" per obrir l'escriptori virtual,
només caldrà dir-li al navegador que obri sempre aquest tipus de fitxers amb
el visor virt-viewer i ja no ho demanarà més.

## També et pot interessar

  * [Accés remot al repositori de fitxers](ca/la-fib/serveis-tic/acces-remot-al-repositori-de-fitxers.md)

  * [AulaVirtual](ca/la-fib/serveis-tic/aulavirtual.md)

  * [Aules híbrides Campus Nord](ca/la-fib/serveis-tic/aules-hibrides-campus-nord.md)

  * [Comptes d'usuari als PC i servidors](ca/la-fib/serveis-tic/comptes-dusuari-als-pc-i-servidors.md)
  ...
  * [Distribució de programari](ca/la-fib/serveis-tic/distribucio-de-programari.md)

  * [Entorn de treball als ordinadors](ca/la-fib/serveis-tic/entorn-de-treball-als-ordinadors.md)

  * [Exàmens en entorn segur](ca/la-fib/serveis-tic/examens-en-entorn-segur.md)

  * [Filesender: intercanvi de fitxers de gran volum](ca/la-fib/serveis-tic/filesender-intercanvi-de-fitxers-de-gran-volum.md)
  ...
  * [Lloguer de Laboratoris d'informàtica](ca/la-fib/serveis-tic/lloguer-de-laboratoris-dinformatica.md)

  * [Préstec de material divers](ca/la-fib/serveis-tic/prestec-de-material-divers.md)

  * [Préstec de portàtils](ca/la-fib/serveis-tic/prestec-de-portatils.md)

  * [Programari instal·lat als ordinadors](ca/la-fib/serveis-tic/programari-installat-als-ordinadors.md)
...
Tingues en compte la [Normativa d'ús de l'equipament informàtic](ca/la-
fib/serveis-tic/normativa-dus-de-lequipament-informatic.md)

## Suport TIC FIB

Fes-nos arribar les incidències, dubtes, com aquelles recomanacions o temes
...
[Configuració de privadesa](ca/la-fib/serveis-tic/aulavirtual.md)
