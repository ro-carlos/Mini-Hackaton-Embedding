[Vés al contingut](ca/la-fib/serveis-tic/aules-hibrides-campus-nord.md)
  ...
  * [Català](ca/la-fib/serveis-tic/aules-hibrides-campus-nord.md "Aules híbrides Campus Nord")
  * [English](en/fib/it-services/campus-nord-hybrid-classrooms.md "Campus Nord Hybrid Classrooms")
  * Español
...
[ __](ca/la-fib/serveis-tic/aules-hibrides-campus-nord.md)
...
## Aules equipades com aules híbrides

  * Tots els amfiteatres dels aularis A1-A6 s’han equipat amb sistema de **càmeres Minrray i microfonia d’ambient**.  
Per la FIB: A5001, A5002, A6001, A6002.  
Altres centres: A1-001, A1-002, A2-001, A2-002, A3001, A3002, A4001, A4002,
C4002, D5010  

  * A més a més, s'han instal·lat **càmeres Polycom Studio** que porten micròfon ambient i altaveus incorporats.  
Per la FIB:  
A5E01, A5E02, A5102, A5104, A5202, A5204, A6E01, A6E02, A6101, A6102, A6105,
A6103, A6104, A6202, A6203, A6204.  
  
Altres centres:  
A1-104, A1-105, A1-202, A2-104, A2-105, A2-205, A3102, A3105, A3106, A3202,
A3203, A3205, A4102, A4104, A4105, A4202, A4205, A4206  

  * Per a la realització de classes híbrides a laboratoris informàtics, s'han instal·lat **càmeres Polycom Studio** a les aules informàtiques: A5S102, B5S201, B5S202, C6S302 i C6S308.  

  * Per la resta d'aules informàtiques hem equipat els ordinadors de professor/a amb una webcam. També tenim disponible a operació de les aules informàtiques de l'A5 i el C6 webcams en préstec puntual per realitzar una classe híbrida en una aula que no disposi d'equip de  _streaming_ ni de webcam.

## Utilització

__**[Guia per la utilització de les classes
híbrides](sites/fib/files/documents/fib/serveis-
tic/guia_funcionament_aules_hibrides_cn.pdf.md)** (document en constant
actualització)  
[Manual amb instruccions](sites/fib/files/documents/fib/serveis-
tic/instruccions_aules.pdf.md) que trobaràs a les aules

## Suport

### Suport ús càmeres i aules híbrides

Per contactar amb els becaris de suport, podeu adreçar-vos al telèfon
d'operació de l'A5 16043 o directament al mòbil 45772.

### Incidències detectades

**Amfiteatres**

Als amfiteatres la connexió a les càmeres des del PCs falla sovint quan
s'inicia l'ordinador. S'està treballant per solucionar-lo. De moment funciona
seguint aquest ordre:

  1. Estat inicial, PC apagat i diferencial taula baixat.
  2. Engegar el PC
  3. Escollir sistema operatiu Ubuntu/Windows
  4. Després d’escollir el sistema operatiu, quan comença a carregar el SO, i mentre està carregant el SO, pujar diferencial taula.

**Si detecteu alguna incidència addicional si us plau notifiqueu-la
a[utic.fib@upc.edu](utic.fib@upc.edu.md)**

![](/sites/fib/files/images/fib/serveis-tic/aules-hibrides.jpg)
...
[Configuració de privadesa](ca/la-fib/serveis-tic/aules-hibrides-campus-
nord.md)
