[Vés al contingut](ca/la-fib/serveis-tic/audioconferencia.md)
...
[ __](ca/la-fib/serveis-tic/audioconferencia.md)
...
La FIB disposa d'un equip d'audioconferència, model SoundStation2 de la marca
Polycom, que permet fer reunions telefòniques entre varis participants. Aquest
sistema permet que dos o més persones participin en una reunió telefònica, es
a dir, compartint àudio amb un sistema de "mans lliures" integrat. Aquest
equip esta optimitzat per oferir la màxima qualitat possible envers d'un
telèfon convencional amb mans lliures.

Aquest equip és mòbil i es pot fer servir a qualsevol de les [sales de
presentacions de la FIB](ca/la-fib/espais/sales-de-presentacions.md): sala de
reunions, sala de juntes i sala d'actes a l'edifici B6.

## Utilització

Aquest servei s’ofereix a tota la comunitat UPC sense cap cost, exceptuant el
cost de les trucades internacionals que aniran a càrrec de l’usuari.

La reserva d’aquest equip implica fer reserva també de la sala on es farà.
Aquest tràmit es realitzarà a la vegada que feu la reserva d’audioconferència.

Am les dades que es proporcionin en el moment de fer la reserva de l'espai, si
no hi ha problemes de disponibilitat de sala o motius tècnics, l'àrea de
recursos enviarà el pressupost final per tal de que el sol•licitant ho accepti
i així es pugui realitzar l'audioconferència.
...
[Configuració de privadesa](ca/la-fib/serveis-tic/audioconferencia.md)
