[Vés al contingut](ca/la-fib/serveis-tic/distribucio-de-programari.md)
...
[ __](ca/la-fib/serveis-tic/distribucio-de-programari.md)
...
tic.md) » Distribució de programari
...
La UPC distribueix programari amb llicència pel seu estudiantat (Matlab,
Autocad, Minitab...).

A més, la UPC s'ha adherit a la iniciativa de Microsoft _Imagine for Academic
Institutions_. El programa Microsoft Imagine, anteriorment anomenat
DreamSpark, permet posar a disposició del professorat i de l’estudiantat **amb
matrícula vigent** , tant a la UPC com a casa, tota la gamma d'eines de
desenvolupament i disseny, productes de servidor, sistemes operatius,
aplicacions i biblioteques d'informació de Microsoft, perquè els puguin
utilitzar per a la recerca i la docència.

La FIB ha arribat a un acord amb l'empresa RoboDK Inc. per a la utilització
del programari RoboDK als laboratoris docents i aules informàtiques de la FIB.
![](/sites/fib/files/images/fib/serveis-tic/logo_robodk.jpg)

Teniu tota la informació a la pàgina de [Distribució de Programari de la
UPC](ca/distsoft/el-servei/programari-per-a-estudiantsi-professors.md).
...
[Configuració de privadesa](ca/la-fib/serveis-tic/distribucio-de-
programari.md)
