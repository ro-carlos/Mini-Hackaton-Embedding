[Vés al contingut](ca/la-fib/serveis-tic/llistes-de-distribucio.md)
...
[ __](ca/la-fib/serveis-tic/llistes-de-distribucio.md)
...
Les llistes de distribució que existeixen a la FIB són institucionals. Són
llistes restringides i moderades.  
  
El PDI i el PAS poden consultar quines llistes existeixen connectant-se al
[Racó](index.md) i seleccionant l'opció "Comunitat>Llistes de distribució".

## FAQ's

__**Existeixen llistes de distribució d'estudiants?**

Si, hi han per algunes assignatures i el ús es exclusiu del profesor
responsable de l'assignatura, peròla recomenació és utilitzar els avisos del
Racó per a aquestes tasques.

__**Es poden crear noves llistes?**

Si, sempre que siguin institucionals. Per a fer-ho tan sols cal crear un
tiquet a
[https://peticions.utgcntic.upc.edu/](tiquetspeticions/control/main.md)
explicant quins usuaris formaran part de la llista i el nom d'aquesta.
...
[Configuració de privadesa](ca/la-fib/serveis-tic/llistes-de-distribucio.md)
