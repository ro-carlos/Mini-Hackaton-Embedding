[Vés al contingut](ca/la-fib/vida-universitaria/salsam.md)
...
[ __](ca/la-fib/vida-universitaria/salsam.md)
...
universitaria.md) » Salsa'm

L'objectiu del programa és oferir als estudiants internacionals que vénen a la
UPC un suport personalitzat que els permeti integrar-se acadèmicament,
relacionar-se amb els estudiants locals i practicar llengües.

Els centres que hi participen actualment són: EEBE, ETSAB, ETSETB, ETSECCPB,
FIB, ESEIAAT, FOOT, EETAC i ESAB.

SALSA’M està coordinat per l'SLT i per un equip d’estudiants becaris, i
s’organitza en col·laboració amb el Gabinet de Relacions Internacionals i
Empresa i les àrees de relacions internacionals dels centres.

![](/sites/fib/files/images/fib/salsam.jpg)

Aquest programa va arrencar el curs 2015/2016 Q1 amb una prova pilot en la
qual només participaven 3 centres, però a la següent edició, 2015/2016 Q2, la
FIB ja es va incorporar al projecte. I fins ara!

Cada quadrimestre fem dues crides: una per captar mentors (buddy) i una altra
per captar incomings. El SLT s’encarrega de tota la resta del procés: gestiona
les sol·licituds de mentors per centre, fa els emparellaments buddy-incoming
també per centre, planifica les activitats comunes i el seu calendari, avalua
els emparellaments i, en funció del seu resultat, assigna crèdits o no a la
tasca del buddy, etc.

Intentem que els nostres estudiants del programa SALSA’M puguin gaudir
d’alguna activitat específica. Ja portem uns quants cursos oferint-los accés
gratuït i visita guiada al 4YFN, una activitat que forma part del Mobile World
Congress. I també han tingut entrada gratuïta per a l'IOTSWC.

Els coordinadors i mentors avaluats satisfactòriament al final de la seva
participació en el programa reben crèdits per activitats extrauniversitàries
(6 i 3 ECTS, respectivament).
...
[Configuració de privadesa](ca/la-fib/vida-universitaria/salsam.md)
