[Pasar al contenido principal](es/estudios/secretaria/tramites/acreditacion-
competencia-generica-en-3a-lengua.md)
...
[ __](es/estudios/secretaria/tramites/acreditacion-competencia-generica-
en-3a-lengua.md)
...
# Acreditación competencia genérica en 3a lengua

## Usted está aquí

[Inicio](es.md) » [Estudios](es/estudios.md) »
[Secretaría](es/estudios/secretaria.md) »
[Trámites](es/estudios/secretaria/tramites.md) » Acreditación competencia
genérica en 3a lengua

En el momento de solicitar la expedición del título tienes que haber
**acreditado** el logro de la competencia transversal en una tercera lengua,
tal como se establece a la [NAGRAMA 3.3. Logro de la competencia transversal
en una tercera lengua en los estudios de
grado.](sga/ca/normatives/NormativesAcademiques/NormativesAcademiques.md)

Desde la implantación de los grados la normativa académica de la UPC considera
lograda la competencia por medio de una de las**3 vías siguientes:**

1\. Presentando un **certificado** del [nivel B2 o superior,](slt/ca/cursos-i-
certificats/certifica/taulacertificats.md) a través de la sede electrónica.  
  
2\. Elaborando y defendiendo el Trabajo de fin de Grado (**TFG**) en una
tercera lengua. (Redactando de manera completa y defendiendo íntegramente el
TFG en inglés, preferentemente.)  
  
3\. Obteniendo un mínimo de**9 ECTS** correspondientes a **una** o la
**combinación de más de una de las siguientes** :  
  
a) Cursar **asignaturas** de estudios de la UPC impartidas completamente en
inglés, en que el estudiante tiene que haber utilizado oralmente y por escrito
esta lengua.  
  
b) Hacer una **estancia** en una universidad o empresa en el extranjero en el
marco de un programa de movilidad o de un convenio de cooperación educativa en
que la actividad se haga en una tercera lengua.  
  
c) Cursar y superar **durante** los estudios actividades con reconocimiento de
créditos del itinerario de lenguas y comunicación, centradas en el aprendizaje
de los idiomas alemán, inglés, francés o italiano. Estas actividades tienen
que estar reconocidas en el expediente de grado correspondiente.

[Web del Servicio de Lenguas y Terminologías](slt/es.md)
...
licitud_acreditacio_tercera_llengua.md)
  ...
  * [Cuándo](es/estudios/secretaria/tramites/acreditacion-competencia-generica-en-3a-lengua.md)
  * [ Dirigido a](es/estudios/secretaria/tramites/acreditacion-competencia-generica-en-3a-lengua.md)
  * [ Documentación necesaria](es/estudios/secretaria/tramites/acreditacion-competencia-generica-en-3a-lengua.md)
  * [ Normativa asociada](es/estudios/secretaria/tramites/acreditacion-competencia-generica-en-3a-lengua.md)
  * [ Tasas](es/estudios/secretaria/tramites/acreditacion-competencia-generica-en-3a-lengua.md)
  * [ Contacto](es/estudios/secretaria/tramites/acreditacion-competencia-generica-en-3a-lengua.md)

Durante los estudios de Grado, antes de solicitar el título.

Estudiantado de los diferentes Grados de la FIB.

  * Original del certificado o titulo de nivell B2 o superior.
  * En los supuestos 1, 2 y 3 la acreditación es automática y no habrá que presentar nada:

1\. Obteniendo un mínimo de 9 ECTS correspondientes a asignaturas impartidas
en una tercera lengua.  
2\. Elaborando y defendiendo el trabajo de fin de grado en una tercera lengua.  
3\. Haciendo una estancia en una universidad o empresa extranjera en el marco
de un programa de movilidad o de un convenio de cooperación educativa,
obteniendo un mínimo de 9 ECTS.

[Normativa académica de la UPC](sga/ca/shared/fitxers-
normatives/NormativesAcademiques/NAGRAMA.md)
...
[Configuración de privacidad](es/estudios/secretaria/tramites/acreditacion-
competencia-generica-en-3a-lengua.md)
