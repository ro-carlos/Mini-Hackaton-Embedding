[Pasar al contenido principal](es/estudios/secretaria/tramites/solicitud-del-
titulo-y-del-suplemento-europeo-al-titulo.md)
  ...
  * [Català](ca/estudis/secretaria/tramits/sollicitud-del-titol-i-suplement-europeu-al-titol.md "Sol·licitud del títol i Suplement Europeu al Títol")
  * [English](en/studies/academic-management/administrative-procedures/application-degree-and-diploma-supplement-ds.md "Application for the Degree and the Diploma Supplement \(DS\)")
  * [Español](es/estudios/secretaria/tramites/solicitud-del-titulo-y-del-suplemento-europeo-al-titulo.md "Solicitud del título y del Suplemento Europeo al Título")
...
[ __](es/estudios/secretaria/tramites/solicitud-del-titulo-y-del-suplemento-
...
# Solicitud del título y del Suplemento Europeo al Título

## Usted está aquí

[Inicio](es.md) » [Estudios](es/estudios.md) »
[Secretaría](es/estudios/secretaria.md) »
[Trámites](es/estudios/secretaria/tramites.md) » Solicitud del título y del
Suplemento Europeo al Título

Los estudiantes y las estudiantes, una vez han cumplido los requisitos
necesarios, tienen derecho a solicitar la expedición del título universitario
oficial correspondiente y del Suplemento Europeo al Título (SET) que lo
acompaña.
...
#### Inicia el trámite
  ...
  1. Accede a la [e-Secretaria](index.md) para iniciar el trámite de solicitud de título.

  2. Selecciona la opción de menú: Títulos y solicitudes.

  3. Clica el botón "Solicita título" para iniciar el trámite.

  4. Revisa tus**datos personales**.

     * Nombre y apellidos tienen que coincidir con el documento identificativo. Añade los acentos y/o las conjunciones "i", "y".

     * Otros datos: Datos de nacimiento: fecha, municipio y país; nacionalidad.

  5. Revisa tus **datos económicos**.

     * Si tienes algún descuento que no figure, ¡indícalo!

  6. Revisa y actualiza, si es necesario, tu domicilio y datos de contacto.

  7. **Añade la documentación** para justificar los datos personales y económicos.

  8. **Guarda** los datos y **envía** a validar el formulario.

#### Validación de los requerimientos, autorización

Una vez enviado a validar el formulario, desde la Facultad, validaremos tu
solicitud.

#### Registro electrónico

Cuando tu **solicitud** esté **autorizada** , podrás continuar con el trámite.

  9. Clica el botón para hacer el **registro en la sede electrónica** de la UPC.

  10. Añade la **firma electrónica** , es decir, clica, firma y registra.

#### Pago de tasas

  11. Vuelve a la e-Secretaría y realiza el **pago**.

**¡Ya puedes descargar tu resguardo del título y también otra
documentación!​**

### Tienes dudas?

Consulta la página del [Servicio de Gestión Académica](sga/ca/titols-i-
set/titols/introduccio.md)

Trámite en línea

[e-Secretaria](index.md)

  * [Cuándo](es/estudios/secretaria/tramites/solicitud-del-titulo-y-del-suplemento-europeo-al-titulo.md)
  * [ Dirigido a](es/estudios/secretaria/tramites/solicitud-del-titulo-y-del-suplemento-europeo-al-titulo.md)
  * [ Normativa asociada](es/estudios/secretaria/tramites/solicitud-del-titulo-y-del-suplemento-europeo-al-titulo.md)
  * [ Tasas](es/estudios/secretaria/tramites/solicitud-del-titulo-y-del-suplemento-europeo-al-titulo.md)

Una vez el estudiante cumpla con las condiciones para solicitar el título.

Estudiantes que han superado la totalidad de los créditos que prevee su plan
de estudios. En el caso del Grado, deberá también haber acreditado que se ha
logrado la competencia genérica en tercera lengua.

  * [Normativa Académica de los estudios de grado y máster de la UPC (NAGRAMA)](sga/es/normativas/NormativasAcademicas/NormativasAcademicas.md)
  * [Procedimientos administrativos y de gestión económica vinculados a la NAGRAMA](sga/ca/shared/fitxers-normatives/NormativesAcademiques/NAGRAMA/procediments-2019-2020_informats-favorablement-cdie-juny-2019_definitiu.pdf/view.md) (versión en catalán) 
  * [Real Decreto 1002/2010, de 5 de agosto, sobre expedición de títulos universitarios oficiales](buscar/act.php.md)

Consulta el [decreto de precios públicos](sga/es/matricula-e/precios/decreto-
de-precios-publicos.md)

**Expedición del título: 218,15 €**

Vía e-secretaria. Si el estudiante no tiene acceso a la e-secretaría, se hará
uso de la hoja de pago que la Secretaría le hará llegar.
...
[Configuración de privacidad](es/estudios/secretaria/tramites/solicitud-del-
titulo-y-del-suplemento-europeo-al-titulo.md)
