[Pasar al contenido principal](es/estudios/secretaria/tramites/matricula-
...
[ __](es/estudios/secretaria/tramites/matricula-incoming-1a-matricula.md)
...
# Matrícula Incoming (1ª matrícula)

## Usted está aquí

[Inicio](es.md) » [Estudios](es/estudios.md) »
[Secretaría](es/estudios/secretaria.md) »
[Trámites](es/estudios/secretaria/tramites.md) » Matrícula Incoming (1ª
matrícula)

Si has sido admitido/a para realizar un semestre o todo un curso de
intercambio en la FIB tendrás que formalizar la matrícula en la sesión de
bienvenida.

Trámite presencial

  * [Cuándo](es/estudios/secretaria/tramites/matricula-incoming-1a-matricula.md)
  * [ Dirigido a](es/estudios/secretaria/tramites/matricula-incoming-1a-matricula.md)
  * [ Documentación necesaria](es/estudios/secretaria/tramites/matricula-incoming-1a-matricula.md)
  * [ Tasas](es/estudios/secretaria/tramites/matricula-incoming-1a-matricula.md)
...
Estudiantado de intercambio que se tiene que matricular por primera vez en la
FIB.

Documentación obligatoria a subir a la [plataforma de movilidad](index.md)
antes de la Welcome Session:

  * Acuerdo académico debidamente firmado (sólo en caso de que tu universidad pertenezca a un país de fuera del programa Erasmus+ o si tu universidad no está conectada a la plataforma Erasmus Without Papers). 
  * Una fotocopia de la matrícula realizada en tu universidad de origen en la que conste que estás matriculado durante el período de intercambio.
  * Una fotocopia de tu pasaporte o del carnet de identidad.
  * Seguro con las coberturas siguientes: Asistencia sanitaria (incluidas las pruebas diagnósticas e intervenciones quirúrgicas), cobertura por accidentes en el país de destino y repatriación en caso de fallecimiento. En caso de no disponer ya de un seguro, la UPC tiene convenio con [OnCampus](seguros/oncampus-estudia.md) y ofrece un seguro muy completo para toda la estancia a un precio bastante económico (La Tarjeta Sanitaria Europea no es suficiente, puesto que no tiene todas las coberturas requeridas).
...
[Configuración de privacidad](es/estudios/secretaria/tramites/matricula-
incoming-1a-matricula.md)
