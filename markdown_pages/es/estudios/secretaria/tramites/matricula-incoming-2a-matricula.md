...
[ __](es/estudios/secretaria/tramites/matricula-incoming-2a-matricula.md)
...
# Matrícula Incoming (2ª matrícula)

## Usted está aquí

[Inicio](es.md) » [Estudios](es/estudios.md) »
[Secretaría](es/estudios/secretaria.md) »
[Trámites](es/estudios/secretaria/tramites.md) » Matrícula Incoming (2ª
matrícula)

Para poderte matricular el 2º semestre de la estancia en la FIB, tendrás que
enviar un correo electrónico a  confirmando los cursos que quieres hacer,
teniendo en cuenta que hay un acuerdo académico firmado previamente y, por lo
tanto, no tendrían que haber muchos cambios. Aún así, si quieres hacer algún
cambio tendrás que tener en cuenta que es obligatorio cumplir con los
requisitos de las asignaturas y comprobar que no hay solapamiento entre ellas.
En caso de solapamiento, no se aceptarán los cambios.

El estudiante que durante el 2º semestre deba defender el proyecto final de
carrera (TFG/TFM) deberá hacer la inscripción del proyecto, antes de la fecha
límite, para matricularlo.

Consulta el [calendario académico](es/estudios/secretaria/calendarios-
academicos.md) para saber cuando empiezan las clases del 2º semestre.

Trámite en línea

[e-Secretaria](estudiants.md)

  * [Cuándo](es/estudios/secretaria/tramites/matricula-incoming-2a-matricula.md)
  * [ Dirigido a](es/estudios/secretaria/tramites/matricula-incoming-2a-matricula.md)
  * [ Tasas](es/estudios/secretaria/tramites/matricula-incoming-2a-matricula.md)
  * [ Contacto](es/estudios/secretaria/tramites/matricula-incoming-2a-matricula.md)
...
Estudiantado de intercambio que ha estado matriculado el cuatrimestre anterior
en la FIB.

Este trámite es gratuito.

## [Relacions Internacionals FIB](es/node/16007.md)
