[Pasar al contenido principal](es/estudios/secretaria/tramites/reconocimiento-
de-asignaturas.md)
  ...
  * [Català](ca/estudis/secretaria/tramits/reconeixement-dassignatures.md "Reconeixement d'assignatures")
  * English
  * [Español](es/estudios/secretaria/tramites/reconocimiento-de-asignaturas.md "Reconocimiento de asignaturas")
...
[ __](es/estudios/secretaria/tramites/reconocimiento-de-asignaturas.md)
...
[Secretaría](es/estudios/secretaria.md) »
[Trámites](es/estudios/secretaria/tramites.md) » Reconocimiento de asignaturas

El reconocimiento es la aceptación, en unos estudios oficiales de la UPC, de
los créditos que habiendo sido obtenidos en unas enseñanzas oficiales, en la
propia UPC o en cualquier otra universidad, son computados a efectos de la
obtención de un título oficial. Este reconocimiento implica el establecimiento
de una equivalencia por lo que respecta a competencias específicas y/o
transversales y a carga de trabajo por parte del estudiante entre asignaturas
de planes de estudios conducentes a la obtención de títulos oficiales.

El reconocimiento debe realizarse siempre a partir de las asignaturas cursadas
en los estudios de origen, nunca a partir de asignaturas convalidadas,
adaptadas o reconocidas previamente.

## Como realizar la solicitud?

  1. Antes de iniciar el trámite se debe tener la documentación necesaria digitalizada en formato PDF. Consulta el apartado ‘Documentación necesaria’ de este trámite.
  2. El estudiante deberá registrar uns [Solicitud de reconocimiento/convalidación de asignaturas por otros estudios universiarios](ca/Tramits/Sol-licitud_reconeixement_convalidacions_assignatures.md) en la sede electrónica de la UPC. 
     * acceder al trámite con la [Identidad Digital UPC](identitatdigital/ca.md) (usuario/contraseña)
  3. Hacer clic en el botón “Tramita (Comunidad UPC" o Tramita (externos UPC)”, según sea el caso.
  ...
  6. Clicar en el botón “Firma y registra”. Es el momento de la firma. Se mostrará una pantalla donde se podrá escoger el método de firma. Seleccionar el que se quiera utilizar y continuar el proceso según las indicaciones.

Una vez completado el proceso de firma, la aplicación informará que se está
procesando el trámite. Cuando la aplicación informe que el trámite se ha
completado correctamente, se podrá descargar el recibo de registro del
trámite. La no recepción del recibo acreditativo significa que la Universitat
Politècnica de Catalunya no ha recibido la solicitud. Por lo tanto, el
documento se tendrá por no presentado a todos los efectos.

Pasados unos minutos se recibirá un correo electrónico con remitente UPC que
contiene:
...
Con este código, si se necesita, al apartado de [autoservicio de documentos de
la Sede Electrónica UPC](ca/sobre-la-seu/eines/autoservei-de-documents.md), se
podrá obtener una copia auténtica de la documentación presentada.

Trámite en línea

[Seu electrònica UPC](ca/Tramits/Sol-
licitud_reconeixement_convalidacions_assignatures.md)

  * [Cuándo](es/estudios/secretaria/tramites/reconocimiento-de-asignaturas.md)
  * [ Dirigido a](es/estudios/secretaria/tramites/reconocimiento-de-asignaturas.md)
  * [ Documentación necesaria](es/estudios/secretaria/tramites/reconocimiento-de-asignaturas.md)
  * [ Normativa asociada](es/estudios/secretaria/tramites/reconocimiento-de-asignaturas.md)
  * [ Tasas](es/estudios/secretaria/tramites/reconocimiento-de-asignaturas.md)
  * [ Contacto](es/estudios/secretaria/tramites/reconocimiento-de-asignaturas.md)
...
Estudiantes de:
  ...
  * Grado en Ingeniería Informática (vias de acceso 7 y 8)
  * Grado en Ciencia e Ingenieria de Datos (vias de acceso 7 y 8)
...
que han resultado admitidos/das en la FIB, y provienen de otros centros de la
UPC, o bien de otras universidades españolas o extranjeras.

Deberá adjuntar en la sede electrónica:

  * La solicitud de reconocimiento de asignaturas (documento adjunto a continuación) debidamente cumplimentada.
  * Certificación académica personal (original o fotocopia validada) que acredite los estudios que se desea reconocer (sólo para estudios no cursados en la UPC).
  * Plan de estudios y programa de las asignaturas, publicado por el centro correspondiente (sólo para estudios no cursados en la UPC).

En el caso de los estudiantes que deseen reconocer estudios universitarios
realizados en el extranjero, los documentos académicos deben ser oficiales,
originales y expedidos por las autoridades competentes, y deben estar
[legalizados per vía
diplomática](sga/es/expedientes/LegDoc/LegalTraduccDocExtranj.md "legalització
via diplomàtica") y acompañados de la traducción oficial al castellano o
catalán.

Documentos:

![Icono PDF](/modules/file/icons/application-pdf.png) [Instancia de
reconocimiento de
asignaturas](sites/fib/files/tramits/instancia_reconeixements_assignatures_1.pdf.md
"instancia_reconeixements_assignatures.pdf")

[Normativa Académica de los estudios de Grado y Máster
(NAGRAMA)](sga/es/normativas/NormativasAcademicas.md)

Consulta el [decreto de precios](sga/es/matricula-e/precios/decreto-de-
precios-publicos.md).

  * Estudios de expediente académico para la convalidación, la adaptación, la transferencia y el reconocimiento de planes de estudios: **54,54 euros**.

Vía [e-Secretaría](apl/home_estudiants.php.md).
...
Atención presencial con [cita previa](omirXW382RQi2jtV9.md).  
Recuerda**indicar el motivo de tu cita**.

  * Mañanas: de lunes a viernes, de 10 a 13 h
  * Tardes: martes y miércoles, de 15.30 a 17 h

Del 1 de junio al 30 de septiembre: de 10 a 13 h de lunes a viernes.
...
[Configuración de privacidad](es/estudios/secretaria/tramites/reconocimiento-
de-asignaturas.md)
