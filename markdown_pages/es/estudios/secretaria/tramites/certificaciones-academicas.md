[Pasar al contenido
principal](es/estudios/secretaria/tramites/certificaciones-academicas.md)
  ...
  * [Català](ca/estudis/secretaria/tramits/certificacions-academiques.md "Certificacions acadèmiques")
  * English
  * [Español](es/estudios/secretaria/tramites/certificaciones-academicas.md "Certificaciones académicas")
...
[ __](es/estudios/secretaria/tramites/certificaciones-academicas.md)
...
[Secretaría](es/estudios/secretaria.md) »
[Trámites](es/estudios/secretaria/tramites.md) » Certificaciones académicas

Se solicita en [**e-Secretaria**](estudiants.md) y se obtenedrá máximo en 4
días hábiles.

_Si tienes acceso a la e-Secretaria_

  1. **Inicia sesión** : Utiliza tus credenciales de acceso a las Intranets de la UPC.
  2. **Busca el trámite** : En el menú izquierdo _Certificados_.
  3. **Elige el certificado** : Indica el tipo de certificado que necesitas (por ejemplo, Certificado académico personal).
  4. **Completa los datos** : Especifica el idioma y el método de pago.
  5. **Paga las tasas** : Realiza el pago en línea a través de la e-Secretaría. 
    1. En el menú, escoger la opción  _Impresos y pagos_.
    2. Seleccionar el último impreso de "Certificación académica" y pulsar el logo de la tarjeta de crédito o de la _Línia Oberta_ de La Caixa.
    3. Escoger una de las dos opciones del listado y se abrirá una página donde confirmar el pago directamente con la entidad bancaria. Más información para realizar el pago en línea en el documento de [instrucciones para hacer el pago por la e-Secretaria](sga/ca/matricula/pagament-de-la-matricula/visa-mastercard-linea-oberta.md).

_Si no tienes acceso a la e-Secretaria,_

  1. **Envía un correo electrónico** : escribe a  adjuntando una fotocopia del DNI vigente (en caso de personas con nacionalidad española) o del pasaporte (en caso de personas con nacionalidad extranjera).

  
  
__**Importante**

  * **Plazo de entrega** : Máximo 4 días hábiles.
  * **Legalización**. Para que los documentos académicos originales tengan efectos en el extranjero es necesario llevar a cabo la legalización.

  
La **legalización de documentos académicos** originales que tienen que tener
efectos al extranjero es un proceso convenido con carácter internacional que
requiere previamente el reconocimiento de firmas por parte de las autoridades
españolas correspondientes. En el caso concreto de los certificados académicos
oficiales de estudios conducentes a la obtención de los títulos, expedidos y
firmados por cargos académicos de las unidades académicas de la UPC (centros
docentes, departamentos e institutos universitarios de investigación) se tiene
que pedir el certificado para legalizar.

Trámite en línea

[e-Secretaria](estudiants.md)

  * [Cuándo](es/estudios/secretaria/tramites/certificaciones-academicas.md)
  * [ Dirigido a](es/estudios/secretaria/tramites/certificaciones-academicas.md)
  * [ Tasas](es/estudios/secretaria/tramites/certificaciones-academicas.md)
  * [ Contacto](es/estudios/secretaria/tramites/certificaciones-academicas.md)

Se pueden solicitar durante todo el curso.

Personas tituladas o que esten cursando (o hayan cursado) estudios en la FIB.

27,27€ (13’63€, si el o la estudiante pertenece a família numerosa. Esta
circunstancia se debe justificar mediante el título correspondiente).

Este pago puede realizarse mediante:

  * Tarjeta de crédit o débito, en secretaria 
  * En efectivo, en la entitat bancaria con los impresos que, a tal efecto, se proporcionan en Secretaría.
