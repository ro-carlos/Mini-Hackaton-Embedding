[Pasar al contenido principal](es/la-fib/la-facultad/personal.md)
...
[ __](es/la-fib/la-facultad/personal.md)
...
Transversal de Gestión del ámbito TIC en el Campus Nord](ca.md) (UTGCNTIC)
tienen como misión responder con polivalencia ante las demandas de los
usuarios y de mantener los estándares de calidad en el servicio.
...
**Unidades que dan servicio esclusivo a la FIB**
  ...
  * [Unidad de Gestión de estudios de grado y master FIB](ca/estructura/unitat-gestio-estudis-grau-master-fib.md)
  * [Unidad de ayuda institucional y relaciones externas FIB](ca/estructura/unitat-suport-institucional-relacions-externes-fib.md)

**Unidades transversals que dan servicio a la FIB y a otras unidades
académicas y de investigación de la UTG**

  * [Unidad de Servicios TIC](ca/estructura/unitat-serveis-tic.md)
  * [Unidad de Recursos y servicios](ca/estructura/unitat-recursos-serveis.md)

[![](/sites/fib/files/images/fib/logo_inlabfib_pet.png)](es.md)

[Personal inLab FIB](es/comunidad.md)
...
[Configuración de privacidad](es/la-fib/la-facultad/personal.md)
