[Pasar al contenido principal](es/la-fib/servicios-tic/software-instalado-en-
los-ordenadores.md)
...
[ __](es/la-fib/servicios-tic/software-instalado-en-los-ordenadores.md)
...
# Software instalado en los ordenadores

## Usted está aquí

[Inicio](es.md) » [La FIB](es/la-fib.md) » [Servicios TIC](es/la-
fib/servicios-tic.md) » Software instalado en los ordenadores
...
A continuación se lista el software instalado para cada sistema operativo.
Durante el curso académico no se realizan nuevas instalaciones de software.

En primavera el la FIB envia un email a todos los profesores para pedir las
necesidades de software para el curso siguiente.
...
[Configuración de privacidad](es/la-fib/servicios-tic/software-instalado-en-
los-ordenadores.md)
