[Pasar al contenido principal](es/la-fib/servicios-tic/el-raco.md)
  ...
  * [Català](ca/la-fib/serveis-tic/el-raco.md "El Racó")
  * [English](en/fib/it-services/el-raco.md "El Racó")
  * [Español](es/la-fib/servicios-tic/el-raco.md "El Racó")
...
[ __](es/la-fib/servicios-tic/el-raco.md)
...
El [Racó](index.md) es la Intranet de la FIB, a la que se accede con el
usuario de las intranets UPC.

Las funcionalidades disponibles desde el Racó dependen del perfil del usuario
(Estudiante, PAS, PDI ...). Encontrará información y herramientas para soporte
a la docencia, herramientas de comunicación, información académica
personalizada, herramientas de usuario y enlaces personalizados.  

## Utilización

En caso de problemas con el acceso (no puede entrar o ha olvidado su
contraseña) puede conectarse al [servicio de identidad
digital](gcredencials/init.md) y seguir las instrucciones para cambiar la
contraseña.

**Los estudiantes, desde el Racó, podéis obtener funcionalidades relativas a
las asignaturas que os habéis matriculado, como son:**

  * Ver los avisos, notas y convocatorias de examen
  * Participar en los foros abiertos por los profesores de la asignatura
  * Entregar prácticas vía web propuestas por los profesores de la asignatura
  * Ver / llenar las encuestas ECTS de la asignatura
  * Presentación / Votación / Ver el delegado de la asignatura
  * Ver los profesores de la asignatura
  * Ver los horarios de los diferentes grupos de la asignatura
  * Ver la página de la guía docente
  * Introducir memoria, resumen y palabras clave del PFM
  * Introducción del informe previo, la fecha de lectura, la memoria, el resumen y las palabras clave del TFG

**Otras funcionalidades a las que el estudiante tiene acceso son:**

  * La agenda
  * Acceso a los foros públicos
  * Buscar estudiantes
  * Ver las noticias de las asociaciones de estudiantes
  * Lista de delegados de las asignaturas en que me he matriculado
  * Ver el horario de las asignaturas en que me he matriculado
  * Reservas de portátiles de la FIB y ESAII
  * Ver la hora de matrícula y de qué me puedo matricular (periodos de matrícula)
  * Personalización (datos personales, página web personal, enlaces interesantes)
  * Suscripciones a servicios
  * Ver el expediente académico
  * Trámites con secretaría (cambios de grupo, de matrícula, instancia de reconocimiento de créditos ...)
  * Cambiar contraseña
  * Inscripción al curso intensivo

**El PDI, desde el Racó, podrá obtener funcionalidades relativas a las
asignaturas que imparte, como son:**

  * Listados de clase en diferentes formatos
  * Gestionar los avisos, notas y convocatorias de examen
  * Abrir foros para la asignatura
  * Configurar la entrega de las prácticas vía web
  * Ver los horarios
  * Acceso al espacio de disco de la asignatura
  * Resultados de las encuestas ECTS

**Para el PDI que además es responsable de alguna asignatura:**

  * Mantenimiento de la guía docente en los tres idiomas
  * Enviar las notas finales
  * Mantener la información de los profesores asignados a la asignatura
  * Ver los horarios provisionales
  * Introducir información sobre el AAD

**Otras funcionalidades para el PDI:**

  * Buscar estudiantes
  * Referente a los trabajos de fin de estudio(TFG/TFM): 
    * Proponer ofertas
    * información de los TFG/TFM en los que interviene o ha intervenido
    * petición de recursos para los estudiantes de TFG y TFM
    * ver los informes previos
    * ver las memorias
  * Participar en foros públicos
  * Normativas e información de interés
  * Seguimiento de tus alumnos tutorizados

## FAQ's

__**Soy un profesor que tiene que dar clases en la FIB y no tengo acceso al
Rincón. ¿Qué debo hacer?**

Para poder acceder al Racó debes tener docencia asignada en la FIB. Asegúrate
que tu departamento ha pasado la información a la facultad y si aún así no
apareces en el Racó, contacta con la FIB a través de
[https://peticions.utgcntic.upc.edu/tiquetspeticions/control/main?idEmpresa=103958](tiquetspeticions/control/main.md)
>> FIB UTIC: Consultas informáticas

## También te puede interesar

  * [API de la FIB](es/la-fib/servicios-tic/api-de-la-fib.md)

  * [Atenea](es/la-fib/servicios-tic/atenea.md)

  * [Detección de plagio](es/la-fib/servicios-tic/deteccion-de-plagio.md)

  * [e-Secretaria](es/la-fib/servicios-tic/e-secretaria.md)

  * [El Racó](es/la-fib/servicios-tic/el-raco.md)

  * [GitHub. Repositorio de código de las Apps](es/la-fib/servicios-tic/github-repositorio-de-codigo-de-las-apps.md)

  * [MediaFib: Archivos de vídeo y eventos en directo](es/la-fib/servicios-tic/mediafib-archivos-de-video-y-eventos-en-directo.md)

  * [UPCommons](es/la-fib/servicios-tic/upcommons.md)
...
[Configuración de privacidad](es/la-fib/servicios-tic/el-raco.md)
