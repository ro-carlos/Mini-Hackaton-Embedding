[Pasar al contenido principal](es/la-fib/servicios-tic/videoconferencia.md)
...
[ __](es/la-fib/servicios-tic/videoconferencia.md)
...
fib/servicios-tic.md) » Videoconferencia
...
La videoconferencia permite a un grupo de personas ubicadas en lugares
distintos tener reuniones como si estuvieran en la misma sala.

Es una combinación tecnológica de audio, vídeo y redes de comunicación que
sirve para que grupos o individuos puedan interaccionar en un tiempo real como
si estuvieran cara a cara.

Una evolución o tipo de videoconferencias son las webconference o conferencias
web que describimos en el [servicio Webconference](es/la-fib/servicios-
tic/webconference.md).

La FIB dispone de dos equipos de videoconferencia Polycom HDX7000 con
protocolo H.323 y H.239 (doble canal de vídeo) situados en la sala de
Reuniones y en el aula A6S203. Es un hardware especializado que permite dar
una buena calidad de imagen y sonido adaptándose al ancho de banda de la red
de comunicaciones. Los dos equipos tienen capacidad de
[MCU](wiki/Unidad_de_Control_Multipunto.md) pudiéndose conectar hasta con 3
lugares remotos simultáneamente. Gracias al doble canal de vídeo pueden enviar
y recibir contenido informático (PC, portátil, ...) paralelamente a la imagen
de la cámara.

## Utilización

Este servicio es de pago, con un precio reducido si se es miembro de la
comunidad UPC, y totalmente gratuito para el profesorado de la FIB.

La reserva de videoconferencia implica hacer reserva también de la
[sala](es/la-fib/espacios/salas-de-presentaciones.md) donde se hará. Es muy
recomendable hacer una prueba para asegurar la compatibilidad de los equipos y
comprobar la viabilidad de lo que se quiere hacer.

La FIB da soporte a las videoconferencias, para agilizar todo el proceso es
conveniente suministrar los datos necesarios en el momento de hacer la
reserva.

**Recomendaciones para los que intervienen en la videoconferencia:**

  * Evitar, en la medida de lo posible, la ropa de color muy claro. Mejor llevar ropa oscura.
  * Evitar los movimientos bruscos y rápidos.
  * En el caso de que se quiera hacer una presentación con el portátil o PC intentar usar letra con tamaño grande (32 puntos como mínimo) y que haya bastante contraste entre el fondo escogido y las letras.
...
[Configuración de privacidad](es/la-fib/servicios-tic/videoconferencia.md)
