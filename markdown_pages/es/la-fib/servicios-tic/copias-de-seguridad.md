[Pasar al contenido principal](es/la-fib/servicios-tic/copias-de-seguridad.md)
...
[ __](es/la-fib/servicios-tic/copias-de-seguridad.md)
...
fib/servicios-tic.md) » Copias de seguridad
...
La FIB ofrece un servicio de copias de seguridad de los datos que los usuarios
tienen en nuestros servidores.

## Utilización

Periódicamente se realizan copias de seguridad de los servidores de la FIB.
Los datos de los que se realiza copia de seguridad son los ficheros que
tengáis guardados en vuestro espacio de usuario (directorio  _/dades_ en Linux
y unidad  _F:/_ en Windows) y de los correos electrónicos.  
  
Las copias de seguridad se realizan al final del día, por lo tanto, no se
podrá recuperar un fichero que hayáis creado y borrado en el mismo día.

En caso de querer recuperar algún fichero perdido accidentalmente (y no lo
encontráis en la papelera), tenéis que contactar con la FIB mediante
[https://peticions.utgcntic.upc.edu/tiquetspeticions/control/main?idEmpresa=103958](tiquetspeticions/control/main.md)
indicando:

  * El nombre de usuario
  * El nombre del servidor: por ejemple si ha sido en algún servidor Unix, indicad su nombre, o si ha sido en el servidor de correo o en el entorno de las aulas windows o linux 
  * Directorio y nombre del fichero 
  * Fechas de creación y del día del que queréis recuperar el fichero.

La recuperación no se realiza al momento ya que es un proceso manual, y por lo
tanto puede tardar 24-48 horas en días laborables.

## FAQ's

__**He reiniciado un PC de los laboratorios y un fichero que tenia no aparece,
¿por qué?**

Los ficheros que seguro se conservan cuando reiniciáis un PC de los
laboratorios son los que se guardan en vuestro espacio de usuario. Por
ejemplo, guardar archivos en el escritorio de Windows puede provocar que el
perfil se quede corrupto y los ficheros de éste queden inaccesibles. Lo mismo
pasa con el /home de linux.  
Recordad que solo se realiza copia de seguridad del directorio /dades (Linux)
y de la unidad F: (Windows).
...
[Configuración de privacidad](es/la-fib/servicios-tic/copias-de-seguridad.md)
