[Pasar al contenido principal](es/investigacion/departamentos/estadistica-e-
investigacion-operativa.md)
...
[ __](es/investigacion/departamentos/estadistica-e-investigacion-operativa.md)
...
[Departamentos](es/investigacion/departamentos.md) » Estadística e
...
El Departamento de Estadística e Investigación Operativa (DEIO) de la
Universitat Politècnica de Catalunya (UPC) impulsa la investigación y la
docencia en ámbitos muy diversos, como por ejemplo la ingeniería industrial,
el desarrollo de interfaces inteligentes y sistemas automáticos de
procesamiento de datos, la optimización y simulación de flujos en redes y
aplicaciones de todo lo anterior.

El departamento realiza su investigación y transferencia de tecnología
mediante sus [grupos de investigación](es/recerca-es/grupos-de-
investigacion.md).

## Producción científica

Da un vistazo a la página web de la producción científica de la investigación
de la UPC: [futur.upc.edu](715.md)
...
[Configuración de privacidad](es/investigacion/departamentos/estadistica-e-
investigacion-operativa.md)
