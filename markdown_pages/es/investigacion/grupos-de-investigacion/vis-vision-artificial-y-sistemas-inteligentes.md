[Pasar al contenido principal](es/investigacion/grupos-de-investigacion/vis-
vision-artificial-y-sistemas-inteligentes.md)
  ...
  * [Català](ca/recerca/grups-de-recerca/vis-visio-artificial-i-sistemes-intelligents.md "VIS - Visió Artificial i Sistemes Intel.ligents")
  * [English](en/research/research-groups/vis-vision-and-intelligent-systems.md "VIS - Vision and Intelligent Systems")
  * [Español](es/investigacion/grupos-de-investigacion/vis-vision-artificial-y-sistemas-inteligentes.md "VIS - Visión Artificial y Sistemas Inteligentes")
...
[ __](es/investigacion/grupos-de-investigacion/vis-vision-artificial-y-
sistemas-inteligentes.md)
...
Investigación](es/investigacion/grupos-de-investigacion.md) » VIS - Visión
...
![](/sites/fib/files/images/vis.jpg)

![](/sites/fib/files/images/vis2.jpg)

El grupo de Visión Artificial y Sistemas Inteligentes (VIS) está formado por
miembros del departamento de Ingeniería de Sistemas, Automática e Informática
Industrial y del Instituto de Robótica e Informática Industrial (IRI).

El objetivo principal del grupo es la investigación básica y aplicada en el
desarrollo de sistemas inteligentes capaces de interactuar con el mundo de
manera autónoma y ubicua. Estos sistemas inteligentes deberán percibir,
razonar, planificar, actuar y aprender de la experiencia previa. El Grupo
trabaja activamente en temas como la segmentación y el etiquetado robusto de
imágenes en color, el reconocimiento de formas, el aprendizaje y
reconocimiento de objetos invariantemente a las condiciones de iluminación y
del punto de vista, el seguimiento de objetos y personas, la biométrica, el
procesamiento y el análisis de imágenes médicas para la ayuda al diagnóstico,
el análisis de documentos, la navegación de robots móviles, la
autolocalización y la construcción de mapas concurrentes , el control de
sistemas de retroalimentación visual o la interacción persona-máquina.

Web  [http://vis.upc.edu/](index.md)

## Producción científica

Da un vistazo a la página web de la producción científica de la investigación
de la UPC: [futur.upc.edu](VIS.md)
...
[Configuración de privacidad](es/investigacion/grupos-de-investigacion/vis-
vision-artificial-y-sistemas-inteligentes.md)
