[Pasar al contenido principal](es/investigacion/grupos-de-investigacion/cnds-
redes-de-computadores-y-sistemas-distribuidos.md)
  ...
  * [Català](ca/recerca/grups-de-recerca/cnds-xarxes-de-computadors-i-sistemes-distribuits.md "CNDS - Xarxes de Computadors i Sistemes Distribuïts")
  * [English](en/research/research-groups/cnds-computer-networks-and-distributed-systems.md "CNDS - Computer Networks and Distributed Systems")
  * [Español](es/investigacion/grupos-de-investigacion/cnds-redes-de-computadores-y-sistemas-distribuidos.md "CNDS - Redes de Computadores y Sistemas Distribuidos")
...
[ __](es/investigacion/grupos-de-investigacion/cnds-redes-de-computadores-y-
...
Investigación](es/investigacion/grupos-de-investigacion.md) » CNDS - Redes de
...
El grupo de Redes de Computadores y Sistemas Distribuidos está formado por
profesores del departamento de Arquitectura de Computadores. Se compone de dos
subgrupos: [Statistical Analysis of Networks and Systems (SANS)](index.md) y
[Distributed Systems Group (DSG)](node/607.md).

SANS focaliza su investigación en la captación y analisi estadístico de datos
de dispositivos del internet de las cosas y su aplicación en diferentes áreas
como por ejemplo la supervisión medioambiental, las ciudades inteligentes o el
análisis de modelos de movilidad. Por su parte, el DSG trabaja en redes y
nubes comunitarias a gran escala, sistemas distribuidos orientados a la
economía, particularmente en mecanismos de asignación de recursos por el grid
o P2P, sistemas descentralizados aplicados a redes ambientales y aplicativos
de apoyo al aprendizaje cooperativo

Web  [http://research.ac.upc.es/cnds/](cnds.md)

## Producción científica

Da un vistazo a la página web de la producción científica de la investigación
de la UPC: [futur.upc.edu](CNDS.md)
...
[Configuración de privacidad](es/investigacion/grupos-de-investigacion/cnds-
redes-de-computadores-y-sistemas-distribuidos.md)
