[Pasar al contenido principal](es/investigacion/grupos-de-investigacion/larca-
laboratorio-algoritmica-relacional-complejidad-y-aprendizaje.md)
...
[ __](es/investigacion/grupos-de-investigacion/larca-laboratorio-algoritmica-
relacional-complejidad-y-aprendizaje.md)
...
Investigación](es/investigacion/grupos-de-investigacion.md) » LARCA
-Laboratorio Algoritmica Relacional, Complejidad y Aprendizaje
...
El grupo de Algorítmica Relacional, Complejidad y Aprendizaje (LARCA) está
formado por miembros del departamento de Ciencias de la Computación.

Su objetivo es la resolución de problemas a partir de una aproximación basada
en sólidos principios matemáticos, utilizando herramientas de modelización y
técnicas basadas en la algoritmia, la complejidad computacional, la teoría de
autómatas, la lógica, la matemática discreta, la estadística y los sistemas
dinámicos . Las principales líneas de investigación son:

  * Minería de datos y aprendizaje automático
  * Análisis de datos masivas, con énfasis en los flujos de datos
...
de la UPC: [futur.upc.edu](LARCA.md)
...
[Configuración de privacidad](es/investigacion/grupos-de-investigacion/larca-
laboratorio-algoritmica-relacional-complejidad-y-aprendizaje.md)
