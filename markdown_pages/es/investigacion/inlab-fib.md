[Pasar al contenido principal](es/investigacion/inlab-fib.md)
...
[Inicio](es.md) » [Investigación](es/investigacion.md) » inLab FIB
...
El [inLab FIB](index.md) es un laboratorio de innovación e investigación de la
Facultat d'Informàtica de Barcelona de la UPC, especializado en el desarrollo
de proyectos R+D+i multidisciplinares en el ámbito de las Tecnologías de la
...
[ACCIÓ](ca/inici.md), la Agencia por la Competitividad de la Empresa de la
Generalitat de Catalunya, desde el 2019.

## **Áreas I+D+i**

Las [áreas de especialización del inLab FIB](es/areas-especializacion.md), son
la Ciencia de los Datos y Big Data; la Movilidad Inteligente; la Ingeniería
del Conocimiento y de los Servicios; la Ciberseguridad; la Simulación y la
Optimización; y los entornos TIC de soporte al aprendizaje.
...
desarrollo de [proyectos innovadores](es/proyectos.md) que incorpora la
formación como objetivo, dentro del Programa Talent. Los estudiantes se
integran en equipos formados por personal técnico (PAS) y profesores con
amplia experiencia.
...
La **[participación de las empresas](es/programa-talent.md)** en este programa
se articula a través de la esponsorización y colaboración en proyectos
formativos específicos orientados a la formación integral de los estudiantes.
...
[Configuración de privacidad](es/investigacion/inlab-fib.md)
