[Skip to main content](en/fib/rooms/presentation-rooms.md)
...
[ __](en/fib/rooms/presentation-rooms.md)
...
[Home](en.md) » [The FIB](en/fib.md) » [Rooms](en/fib/rooms.md) » Presentation
Rooms
...
[Auditorium Manuel Martí Recober](en/fib/rooms/presentation-
rooms/auditorium.md)

[](en/fib/rooms/presentation-rooms/auditorium.md)

[Boardroom](en/fib/rooms/presentation-rooms/boardroom.md)

[](en/fib/rooms/presentation-rooms/boardroom.md)

[Conference Room](en/fib/rooms/presentation-rooms/conference-room.md)

[](en/fib/rooms/presentation-rooms/conference-room.md)

## Reservation of a Room

You can reserve a room for special events (conferences, teaching staff
meetings, thesis defences, project revisions, etc.) but not for events that
are held on a weekly or monthly basis.

The rooms can be reserved from 8:00 a.m. to 8:30 p.m. (7:30 p.m. from 1 June
to 30 September).

You can make a reservation using the following application:

[![](/sites/fib/files/images/fib/espais/reserva-recursos-
utgcntic.jpeg)](index.md)

Also, you can make a reservation by sending an email to the UTGCNTIC Resources
and Services Area ( ).
...
If you are making a reservation, please remember to specify:
  ...
  * Technical requirements: 
    ...
    * [Videoconferencing Service](en/fib/it-services/videoconferencing.md). 
      * Number of remote connections and number of attendees.
      * Details of who has established video conferencing (email, IP, ...)
    * [Webconferencing service](en/fib/it-services/web-conferencing.md). What platform wil be used.
    * [Mediafib service.](en/fib/it-services/mediafib-video-files-and-live-events.md) If you need recording or a live broadcast
    * [AudioConference ](en/fib/it-services/audioconference.md)If the call is national or international.

_FIB reserves the right to change the reservation priorities for a meeting of
the School Board or the Standing Committee, or any other institutional event._

The consumption of food or drinks in the rooms is not allowed (except water).
...
Settings](en/fib/rooms/presentation-rooms.md)
