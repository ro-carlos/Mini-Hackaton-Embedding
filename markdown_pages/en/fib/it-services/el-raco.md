[Skip to main content](en/fib/it-services/el-raco.md)
...
[ __](en/fib/it-services/el-raco.md)
...
The [Racó](index.md) is the FIB intranet, which can be accessed by UPC
intranet credentials.

The functionality available in the Racó depends on the user profile (students,
administrative staff, teaching and research staff, and so on).Here you will
find information and tools that provide teaching support, communication tools,
personalised academic information, user tools and personalised links.

## How to use

If you have access problems (you can not enter or have forgotten your
password), you can connect to the[ digital identity
service](gcredencials/init.md) and follow the instructions to change your
password or recover your credentials

**From the Racó, students can access functions related to the subjects they
are enrolled in, such as:**
...
**From the Racó, teaching and research staff may use functionality related to
their subjects, such as:**
...
__**I am a lecturer who has to give classes in the FIB and I don't have access
to the Racó. What should I do?******

In order to access the Racó you must be assigned to the FIB as a lecturer.
Check that your department has passed the information to the School and if you
still do not appear in the Racó, please contact FIB at
[https://peticions.utgcntic.upc.edu/tiquetspeticions/control/main?idEmpresa=103958](tiquetspeticions/control/main.md)
>> FIB UTIC: Informatic consultations
...
## You may also be interested in
  ...
  * [GitHub. Source code repository of Apps made in FIB](en/fib/it-services/github-source-code-repository-apps-made-fib.md)
...
Settings](en/fib/it-services/el-raco.md)
