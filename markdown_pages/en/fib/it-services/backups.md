[Skip to main content](en/fib/it-services/backups.md)
  ...
  * [Català](ca/la-fib/serveis-tic/copies-de-seguretat.md "Còpies de seguretat")
  * [English](en/fib/it-services/backups.md "Backups")
  * [Español](es/la-fib/servicios-tic/copias-de-seguridad.md "Copias de seguridad")
...
[ __](en/fib/it-services/backups.md)
...
FIB provides a backup service for the data that users have stored on our
servers.

## How to use

Periodic backups are made from the FIB servers. Backed up data are the files
that are in your user space on any of the servers, also your emails and
Windows profiles.  
  
Backups are made at the end of the day, therefore you will not be able to
recover a file that has been created and deleted on the same day.  
  
If you have lost a file accidentally and you would like to have it restored,
...
The recovery is not realized immediately because it is a manual process, so it
may take 24-48 hours on weekdays.

## FAQ's

__**I restarted a classroom PC and the file I had cannot be found anywhere,
what happened?**

The only files that are saved when you restart a classroom PC are those that
are stored in your user space. They are also the only files that are backed
up. For example, if you save files to the Windows desktop may cause the
profile to corrupt and therefore inaccessible files can remain. The same goes
for /home Linux. Remember that we only maks backup of directory /data (Linux)
and the F: drive (Windows).
...
Settings](en/fib/it-services/backups.md)
