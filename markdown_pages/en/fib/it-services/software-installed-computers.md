[Skip to main content](en/fib/it-services/software-installed-computers.md)
  ...
  * [Català](ca/la-fib/serveis-tic/programari-installat-als-ordinadors.md "Programari instal·lat als ordinadors")
  * [English](en/fib/it-services/software-installed-computers.md "Software installed on computers")
  * [Español](es/la-fib/servicios-tic/software-instalado-en-los-ordenadores.md "Software instalado en los ordenadores")
...
[ __](en/fib/it-services/software-installed-computers.md)
...
The following there is the list of the installed software for each operating
system. During the academic we will not install new software.

On spring the FIB will send an email to all lecturers asking for the software
needs of the following academic year.

## How to use

**Software** |  **Linux**  
(OpenSuse 15.4  
64 bits)  | **Linux aules S.O.**  
(Ubuntu 16.04 LTS  
32 & 64 bits) |  **Windows** (Windows 10 64 bits)  
---|---|---|---  
Acrobat Reader |  | √ | √  
Adobe Flash Player for Safari |  |  |   
Aircrack-ng (Airodump & Aireplay) |  | √ |   
Ampl/amplide | √ |  | √  
Android Developer Tools (bundle for Mac) |  |  |   
Android NDK & SDK | √ |  |   
Android Studio | √ |  | √  
antlr /antlrworks | √ |  |   
Apache Maven | √ |  |   
...
Compressors varis (gzip/tar/bzip2/7zip…) | √ | √ | √  
Cplex |  |  |   
CutePDF Writer |  |  |   
cvs | √ |  |   
CyberDuck |  |  |   
...
Ettercap |  | √ |   
FileZilla |  |  |   
FlashPlayer (firefox i IE) |  |  |   
flex | √ |  |   
Freeglut-devel | √ |  |   
Freeling | √ |  |   
g++ | √ |  |   
gcc | √ |  |   
gcc i glibc de 32 bits | √ |  |   
gdb | √ |  |   
geany | √ |  | √  
Gecode | √ |  |   
Genymotion | √ |  |   
...
Weka |  |  |   
Wifislax |  | √ |   
Windows 7 Català & English Language Pack |  |  |   
Windows 7 Enterprise SP1 |  |  |   
Wireshark |  | √ |   
Xcode |  |  |   
Xcode Commnad line Tools (gcc, g++, make) |  |  |   
Xournal | √ |  |   
Xquartz (X11) |  |  |   
xsane | √ |  |   
Xv | √ |  |   
...
Settings](en/fib/it-services/software-installed-computers.md)
