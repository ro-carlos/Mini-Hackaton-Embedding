[Skip to main content](en/fib/it-services/filesender-exchange-large-files.md)
  ...
  * [Català](ca/la-fib/serveis-tic/filesender-intercanvi-de-fitxers-de-gran-volum.md "Filesender: intercanvi de fitxers de gran volum")
  * [English](en/fib/it-services/filesender-exchange-large-files.md "Filesender: exchange of large files")
  * [Español](es/la-fib/servicios-tic/filesender-intercambio-de-ficheros-de-gran-volumen.md "Filesender: intercambio de ficheros de gran volumen")
...
[ __](en/fib/it-services/filesender-exchange-large-files.md)
...
# Filesender: exchange of large files
...
It is a web application developed by RedIRIS. This application will allow us
to send or receive files of large volumes (up to 2GB).

## How to use

It is very important to emphasize that to use this service, the sender or
receiver must belong to the RedIRIS community. That is why we will have to
authenticate with our credentials.

Service features

  * Allows you to send / receive files up to 2GB
  * File expiration date
  * Notifications of use via email.

Here we tell you the three basic operations:

  * Send a file
  * Check the history of my transfers
  * Receive a file via invitation

#### **Send a file by email**

Suppose we are members of the RedIRIS community and we want to send a file to
someone.

Access to [filesender.rediris.es](index.md)

![](/sites/fib/files/images/fib/serveis-tic/filesender-acces-image.png)

Click on "Iniciar sesión"

![](/sites/fib/files/images/fib/serveis-tic/filesender-servei-identitat-
image.png)

Choose the institution to which we belong (for example, the UPC) and click on
"proceed".  
The authentication page of the chosen school will appear. Enter our
credentials

![](/sites/fib/files/images/fib/serveis-tic/filesender-credencials-image.png)

The following page will appear, from which we can indicate the files that we
want to send and the recipients.

Fill in the following fields:

A: -> one or more addresses separated by commas  
Subject (optional)  
Message (optional)

Click on the "Select files" button and select the files that we want to send.

Click on the "Send" button.

![](/sites/fib/files/images/fib/serveis-tic/filesender-pujar-arxius-image.png)

The follow-up of the delivery will appear, indicating if it has finished
correctly.

#### **Check my transfers**

Click on the "My Transfers" tab. The list of transfers you have made appears.

![](/sites/fib/files/images/fib/serveis-tic/filesender-mis-transferencias-
image.png)

Here you can forward a file, delete it, view the record, or send a reminder.
You have the options on the right, in "Actions".

#### **Receive a file by email**

This option will allow us to receive a file from someone who does not belong
to a registered institution. The mechanism to do this is to send us an
invitation, and then, he will receive a "token" with which he can upload the
file.

First, we start the session in the filesender service and go to the "Guests"
tab.

![](/sites/fib/files/images/fib/serveis-tic/filesender-pestanya-invitados-
image.png)

We put the email address of the person who wants to send the file and, if we
want, a subject and an explanatory text. We send you the invitation, and he
will receive an email with the following content:

![](/sites/fib/files/images/fib/serveis-tic/filesender-contingut-correu-
image.png)

By clicking on the link, the filesender service will open directly where the
guest can send us the file.

![](/sites/fib/files/images/fib/serveis-tic/filesender-enviar-fitxer-convidat-
image.png)
...
Settings](en/fib/it-services/filesender-exchange-large-files.md)
