[Skip to main content](en/fib/it-services/accounts-pcs-and-servers.md)
...
[ __](en/fib/it-services/accounts-pcs-and-servers.md)
...
All FIB students have an account for accessing the PCs in the labs. Depending
on the registered courses, you have different accounts to access Unix servers,
OS laboratories and different Databases servers:

Lecturers may request to FIB for personal/subject accounts for accessing the
PCs, through
...
After the start-up of one of the systems, it will ask for a username and a
password. Students should use the same account they use to access the Racó,
and lecturers should use the account that was provided by the FIB in response
to their request.

To get to know the work environment, available quotas and everything you need
to work on the PC Labs, please see page [Working environment at the
PCs](en/fib/it-services/working-environment-computer-labs.md)

### Accounts on Unix servers

We have UNIX servers for teaching, you can access to them on the different
subjects you are enrolled in.

In these cases, lecturers of the subject will facilitate data access and
explain how to connect.  
  
You can find more information on the[ FIB servers page for
teaching](en/fib/it-services/servers-teaching.md).

### Database servers accounts

We provide accounts to work with different database servers, for use in FIB
courses or for the Final Project / Master Thesis

Available databases are:

  * MySQL, mysqlfib.fib.upc.es listening on port 3306 / TCP
  * Oracle oraclefib.fib.upc.es listening on port 1521 / TCP
  * Postgres, postgresfib.fib.upc.es listening on port 6433 / TCP

  
Database will be created upon request of the lecturer or director of the Final
Project / Master Thesis

### **PC accounts for the Operating Systems Labs**  

We have three laboratories aimed at conducting Operating Systems courses .
Accounts access to these laboratories will be provided by lecturers the first
day of class. You can find more information about these labs at [Working
environment](en/fib/it-services/working-environment-computer-labs.md), a going
to the special section about Operating Systems Labs.

Lecturers who need new access, some specific software, etc .. to teach a
subject, you can ask FIB by creating a ticket to
[https://peticions.utgcntic.upc.edu/tiquetspeticions/control/main?idEmpresa=103958](tiquetspeticions/control/main.md)

### **Expiration of accounts**

The account will be active only for PC while the student is enrolled in any
course or Final Project / Master Theses, otherwise the account will be
removed.

Specific accounts created for different subjects remain active while the
course is active.
...
Settings](en/fib/it-services/accounts-pcs-and-servers.md)
