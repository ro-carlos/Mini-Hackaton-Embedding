[Skip to main content](en/fib/it-services/distribution-software.md)
  ...
  * [Català](ca/la-fib/serveis-tic/distribucio-de-programari.md "Distribució de programari")
  * [English](en/fib/it-services/distribution-software.md "Distribution of Software")
  * [Español](es/la-fib/servicios-tic/distribucion-de-software.md "Distribución de software")
...
[ __](en/fib/it-services/distribution-software.md)
...
UPC distributes licensed software for their students (Matlab, Autocad, Minitab
...).

Moreover, UPC belongs to the Microsoft Imagine program, formerly called
DreamSpark, can make available to the teachers and students currently
enrolled, both in the classroom and at home, the full range of development
tools and design, server products, operating systems, applications and
Microsoft information libraries, so they can use for research and teaching.

FIB has reached an agreement with RoboDK Inc. enterprise for the utilization
of RoboDK's software in FIB's teaching laboratories and computer classrooms.
![](/sites/fib/files/images/fib/serveis-tic/logo_robodk.jpg)

All the infromation is available on the UPC website: [UPC Software
distribution (cat) ](ca/distsoft/el-servei/programari-per-a-estudiantsi-
professors.md)

[![](/sites/fib/files/images/bxh_2018_programari_estudiantat_320px.png)](ca/distsoft/el-
servei/programari-per-a-estudiantsi-professors.md)  
...
Settings](en/fib/it-services/distribution-software.md)
