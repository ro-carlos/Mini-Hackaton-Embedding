[Skip to main content](en/fib/it-services/loan-devices.md)
  ...
  * [Català](ca/la-fib/serveis-tic/prestec-de-material-divers.md "Préstec de material divers")
  * [English](en/fib/it-services/loan-devices.md "Loan of devices")
  * [Español](es/la-fib/servicios-tic/prestamo-de-material-diverso.md "Préstamo de material diverso")
...
[ __](en/fib/it-services/loan-devices.md)
...
FIB offers to students, PAS and lecturers the possibility of a loan from
different devices, some of which are restricted to enrolled subjects or
taught.

In order to run tests on projects related to the development of mobile
applications with iOS in a physical device, [Social Point](index.md) has
funded two iPhone 5C, two iPad Mini Retina, and two Android Google Nexus 5.

For specific projects to be developed on Windows Phone and Kinect, we have
material provided by Microsoft

Currently devices on loan are:
...
Here are the details of who can reserve the equipment and the kind of loan.

## How to use

#### Loan

To request the loan of any device, students must go to the Servei d'Operació
of the computer labs of A5 or C6 building and show the student card. Once
verified the student is attending any course, FIB will provide the device
needed that has to be returned within 24 hours (or the following Monday if the
loan is made on a Friday).

In order to ensure access to iPhones and iPads to all students, if a student
wants to renew a loan, the student must wait half a day to come back and
request one.

In the case of students registered or enrolled with the final project
(PFC/PFM/TFG), the loan will be done, at the request of their project
director, in the same way. In the non-teaching periods, Final Project students
may request for an extension of their loan.

Lecturers and FIB staff can also request a loan of thses devices, but will
depending on the device you need go to A5 or C6 operation service or to B6
building for UNAID .

Available devices

Device |  Amount  
available | Lecturers | Staff | Students |  Place  
---|---|---|---|---|---  
Iphone 5c | 2 | √ | √ | √ | A5/C6  
Ipad mini retina | 2 | √ | √ | √ | A5/C6  
Google Nexus 5 | 2 | √ | √ | √ | A5  
HTC Wildfire | 8 | √ | √ | √ | A5  
BQ Aquarius X5 | 10 | √ | √ | √ | A5/C6  
Nokia Lumia 625 | 1 | √ | √ | √ | A5  
Xbox+Knect | 1 | √ | √ | √ | A5  
HDMIVGA Adapters | 6 | √ | √ | √ | A5/B6/C6  
[Dell Latitude E6500 Laptop](en/fib/it-services/loan-notebook-computers.md) | 13 | √ | √ | √ | A5/C6  
[Dell Latitude D630 Laptop](en/fib/it-services/loan-notebook-computers.md) | 14 | √ | √ | √ | A5/B6/C6  
[Toshiba Portege R30-A-1C9 Laptop](en/fib/it-services/loan-notebook-computers.md) | 5 | √ | √ | √ | A5/C6  
Conference-CAM | 1 | √ | √ |  | B6  
Command Bags | 2 | √ | √ |  | A5/C6  
Projectors | 2 | √ | √ | √ | A5/B6  
Presentation Pointers | 8 | √ | √ | √ | A5/B6/C6  
Photo Camera | 1 | √ | √ |  | B6  
Camcorder | 1 | √ | √ |  | B6  
Opaque Projector | 1 | √ | √ | √ | B6  
...
Settings](en/fib/it-services/loan-devices.md)
