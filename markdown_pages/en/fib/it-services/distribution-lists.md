[Skip to main content](en/fib/it-services/distribution-lists.md)
  ...
  * [Català](ca/la-fib/serveis-tic/llistes-de-distribucio.md "Llistes de distribució")
  * [English](en/fib/it-services/distribution-lists.md "Distribution Lists")
  * [Español](es/la-fib/servicios-tic/listas-de-distribucion.md "Listas de distribución")
...
[ __](en/fib/it-services/distribution-lists.md)
...
The distribution lists of the FIB are institutional. They are restricted and
moderated lists.  
Professors, research staff and administrative staff may consult the
distribution lists by connecting to the [Racó](index.md) and selecting the
option "Comunitat > Llistes de distribució".

## FAQ's

__**Are there any student distribution lists?**

Yes, there are distribution lists for some subjects and the only one that can
ose it is the professor responsible for the course, but we recommend to use
the Racó notices for these tasks.

__**Can new lists be created?**

Yes, as long as they are for institutional purposes. In order to do this, you
just need to create a tiquet at
[https://peticions.utgcntic.upc.edu](tiquetspeticions/control/main.md)
specifying the name of the list and what users will be part of it.
...
Settings](en/fib/it-services/distribution-lists.md)
