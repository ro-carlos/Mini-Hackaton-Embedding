[Skip to main content](en/research/research-groups/cnds-computer-networks-and-
...
[ __](en/research/research-groups/cnds-computer-networks-and-distributed-
systems.md)
...
Groups](en/research/research-groups.md) » CNDS - Computer Networks and
Distributed Systems
...
The Computer Networks and Distributed Systems research group (CNDS) is formed
by professors of the Department of Computer Architecture. It is divided in two
subgroups: the [Statistical Analysis of Networks and Systems (SANS)](index.md)
and the [Distributed Systems Group (DSG)](node/607.md).

The SANS group focuses its research on the capture and statistical analysis of
data from Internet of Things devices, applied to different areas such as
environmental supervision, smart cities or the analysis of mobility patterns.
On the other hand, the DSG works on large scale and centralized community
networks and community clouds, on economic oriented distributed systems,
particularly on resource allocation mechanisms for grid and peer-to-peer, on
decentralised systems applied to Ambient Networks and on applications
supporting cooperative learning (CSCL).

Website  [http://research.ac.upc.es/cnds/](cnds.md)

## Scientific Production

Take a look at the Website for the scientific production of UPC researchers:
[futur.upc.edu](CNDS.md)
...
Settings](en/research/research-groups/cnds-computer-networks-and-distributed-
systems.md)
