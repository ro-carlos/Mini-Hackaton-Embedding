[Skip to main content](en/research/resarch-groups/dama-upc-data-management-
group.md)
...
[ __](en/research/resarch-groups/dama-upc-data-management-group.md)
...
Groups](en/research/research-groups.md) » DAMA-UPC - Data Management Group
...
The DAta MAnagement research group (DAMA) is formed by members of the
Department of Computer Architecture. It is member of Tecnio since 2005, an
initiative from ACCIO (Agency for Innovation and Internationalization of
Catalan enterprise, belonging to Generalitat de Catalunya), it is recognised
by the Catalan Government as a Consolidated Research Group.

The main research topics of this group are oriented to performance,
exploration and quality in data management, focusing particularly on large
data volumes. We investigate the creation of new data structures, algorithms,
methods and applications in the area of Data Management that make it easier to
manipulate large amounts of data.

Website  [http://www.dama.upc.edu/en](en.md)

## Scientific Production

Take a look at the Website for the scientific production of UPC researchers:
[futur.upc.edu](DAMA-UPC.md)
...
Settings](en/research/resarch-groups/dama-upc-data-management-group.md)
