[Skip to main content](en/research/resarch-groups/dccg-research-group-
discrete-combinatorial-and-computational-geometry.md)
...
[ __](en/research/resarch-groups/dccg-research-group-discrete-combinatorial-
and-computational-geometry.md)
...
Groups](en/research/research-groups.md) » DCCG - Research group on discrete,
...
The research group on Discrete, Combinatorial and Computational Geometry is
formed by members of Department of Mathematics.

Its main research area is the computational geometry, which is a discipline
between the Mathematics and the Theory of Computation. Its main goal is the
design and analysis of algorithms that offer an efficient solution to
geometrical problems. Some research areas are:

  * Algorithms for modular robots and for unique-purpose robots
  * Geometric algorithms
  * Geometric graphs
  * Geographical Information Systems

Website  [http://dccg.upc.edu/](index.md)

## Scientific Production

Take a look at the Website for the scientific production of UPC researchers:
[futur.upc.edu](DCCG.md)
...
Settings](en/research/resarch-groups/dccg-research-group-discrete-
