[Skip to main content](en/research/research-centers/talp-center-language-and-
speech-technologies-and-applications.md)
...
[ __](en/research/research-centers/talp-center-language-and-speech-
...
Centers](en/research/research-centers.md) » TALP - Center for Language and
...
The Centre for Language and Speech Technologies and Applications (TALP) is a
specific interdepartmental research centre at the Universitat Politècnica de
Catalunya (UPC).

The technological scope of the TALP Centre is the automatic processing of both
written and spoken natural language. Its aim is to help overcome language
barriers to improve access to information systems focusing on research and
development in the area of human language processing.

The centre is comprised of two research groups: The Speech Processing Group at
the Department of Signal Theory and Communication and the Natural Language
Processing Group at the Department of Computer Science. Both of them enjoy the
status of a Consolidated Research Group, conferred by the Catalan Government.

![](/sites/fib/files/images/recerca/talp-upc-fib.jpg)

Website  [www.talp.upc.edu/](index.md)

## Scientific Production

Take a look at the Website for the scientific production of UPC researchers:
[futur.upc.edu](TALP.md)
...
Settings](en/research/research-centers/talp-center-language-and-speech-
technologies-and-applications.md)
