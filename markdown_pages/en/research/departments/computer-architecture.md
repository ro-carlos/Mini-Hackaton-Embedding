[Skip to main content](en/research/departments/computer-architecture.md)
...
[ __](en/research/departments/computer-architecture.md)
...
[Departments](en/research/departments.md) » Computer Architecture
...
The Department of Computer Architecture (DAC) at the Universitat Politècnica
de Catalunya (UPC) carries out research and education in the areas of Computer
Architecture, Computer Networks and Operating Systems.  
The research carried out by the DAC is organized in several [research
groups](en/research/research-groups.md). Their scientific production is
published in top conferences and journals.

## Scientific Production

Take a look at the Website for the scientific production of UPC researchers:
[futur.upc.edu](701.md)
...
Settings](en/research/departments/computer-architecture.md)
